...
{
	DECLARE_ABSTRACT_CASTED_CLASS(UField,UObject,CLASS_Intrinsic,Core,CASTCLASS_UField)
	...
	explicit UField( UField* InSuperField );
...
{
	DECLARE_CASTED_CLASS(UStruct,UField,CLASS_Intrinsic,Core,CASTCLASS_UStruct)
...
{
	DECLARE_CASTED_CLASS(UScriptStruct,UStruct,CLASS_Intrinsic,Core,CASTCLASS_UScriptStruct)
...
{
	DECLARE_CASTED_CLASS(UFunction,UStruct,CLASS_Intrinsic,Core,CASTCLASS_UFunction)
...
{
	DECLARE_CASTED_CLASS(UState,UStruct,CLASS_Intrinsic,Core,CASTCLASS_UState)
...
{
	DECLARE_CASTED_CLASS(UEnum,UField,CLASS_Intrinsic,Core,CASTCLASS_UEnum)
...
public:
	// Constructors.
	explicit UEnum( UEnum* InSuperEnum );
...
{
	DECLARE_CASTED_CLASS(UClass,UState,CLASS_Intrinsic,Core,CASTCLASS_UClass)
...
{
	DECLARE_CASTED_CLASS(UConst,UField,CLASS_Intrinsic,Core,CASTCLASS_UConst)
	DECLARE_WITHIN(UStruct)
...
//
template <class T, EClassCastFlag Flag=CASTCLASS_None, UBOOL IncludeSuper=TRUE>
...
protected:
	...
	{
		if ( Flag != CASTCLASS_None )
		{
			while( Struct )
			{
				while( Field )
				{
					if( Field->GetClass()->HasAllCastFlags(Flag) )
					{
						return;
					}
					Field = Field->Next;
...
#define DECLARE_FIELDITERATOR_SPECIALIZATION(ClassType,IncludeSuper) \
template <> \
class TFieldIterator<ClassType,CASTCLASS_None,IncludeSuper> \
{ \
private: \
	/* private class for safe bool conversion */ \
	struct PrivateBooleanHelper { INT Value; }; \
...
protected: \
	...
	{ \
		...
		{ \
			while( Field ) \
			{ \
				if( Field->GetClass()->HasAllCastFlags(CASTCLASS_##ClassType) ) \
				{ \
					return; \
				} \
				Field = Field->Next; \
...
#define DECLARE_FIELD_ITERATOR(ClassName) \
	DECLARE_FIELDITERATOR_SPECIALIZATION(ClassName,TRUE) \
	DECLARE_FIELDITERATOR_SPECIALIZATION(ClassName,FALSE)

DECLARE_FIELD_ITERATOR(UField)
DECLARE_FIELD_ITERATOR(UConst)
DECLARE_FIELD_ITERATOR(UEnum)
DECLARE_FIELD_ITERATOR(UStruct)
DECLARE_FIELD_ITERATOR(UScriptStruct)
DECLARE_FIELD_ITERATOR(UState)
DECLARE_FIELD_ITERATOR(UProperty)
DECLARE_FIELD_ITERATOR(UObjectProperty)
DECLARE_FIELD_ITERATOR(UBoolProperty)
DECLARE_FIELD_ITERATOR(UFunction)
DECLARE_FIELD_ITERATOR(UStructProperty)
DECLARE_FIELD_ITERATOR(UByteProperty)
DECLARE_FIELD_ITERATOR(UIntProperty)
DECLARE_FIELD_ITERATOR(UFloatProperty)
DECLARE_FIELD_ITERATOR(UComponentProperty)
DECLARE_FIELD_ITERATOR(UClassProperty)
DECLARE_FIELD_ITERATOR(UInterfaceProperty)
DECLARE_FIELD_ITERATOR(UNameProperty)
DECLARE_FIELD_ITERATOR(UStrProperty)
DECLARE_FIELD_ITERATOR(UArrayProperty)
DECLARE_FIELD_ITERATOR(UMapProperty)
DECLARE_FIELD_ITERATOR(UDelegateProperty)
