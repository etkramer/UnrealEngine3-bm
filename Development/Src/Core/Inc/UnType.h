...
{
	DECLARE_ABSTRACT_CASTED_CLASS(UProperty,UField,CLASS_Intrinsic,Core,CASTCLASS_UProperty)
	...
	UBOOL HasMetaData(const TCHAR* Key) const
	{
		...
		return Package->GetMetaData()->HasValue(this, Key);
	}
	...
	const FString& GetMetaData(const TCHAR* Key) const
	{
		...
		return Package->GetMetaData()->GetValue(this, Key);
	}
...
{
	DECLARE_CASTED_CLASS(UByteProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UByteProperty)
...
{
	DECLARE_CASTED_CLASS(UIntProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UIntProperty)
...
{
	DECLARE_CASTED_CLASS(UBoolProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UBoolProperty)
...
{
	DECLARE_CASTED_CLASS(UFloatProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UFloatProperty)
...
{
	DECLARE_CASTED_CLASS(UObjectProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UObjectProperty)
	 ...
	 *
	 * @param	Property			the property that the value is being importing to; used only in error messages.
...
{
	DECLARE_CASTED_CLASS(UComponentProperty,UObjectProperty,CLASS_Intrinsic,Core,CASTCLASS_UComponentProperty)
...
{
	DECLARE_CASTED_CLASS(UClassProperty,UObjectProperty,CLASS_Intrinsic,Core,CASTCLASS_UClassProperty)
...
{
	DECLARE_CASTED_CLASS(UInterfaceProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UInterfaceProperty)
...
{
	DECLARE_CASTED_CLASS(UNameProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UNameProperty)
...
{
	DECLARE_CASTED_CLASS(UStrProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UStrProperty)
...
{
	DECLARE_CASTED_CLASS(UArrayProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UArrayProperty)
...
{
	DECLARE_CASTED_CLASS(UMapProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UMapProperty)
...
{
	DECLARE_CASTED_CLASS(UStructProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UStructProperty)
...
{
	DECLARE_CASTED_CLASS(UDelegateProperty,UProperty,CLASS_Intrinsic,Core,CASTCLASS_UDelegateProperty)
...
template <class T, EClassCastFlag Flag> T* FindFieldWithFlag( UStruct* Owner, const TCHAR* FieldName )
{
	// lookup the string name in the Name hash
	FName Name(FieldName, FNAME_Find);
	// If we didn't find it, we know the field won't exist in this Struct
...
template <class T, EClassCastFlag Flag> T* FindFieldWithFlag( UStruct* Owner, FName FieldName )
{
	// Search by comparing FNames (INTs), not strings
	for( TFieldIterator<T,Flag>It( Owner ); It; ++It )
	{
