...
#define VERIFY_CLASS_OFFSET(Pre,ClassName,Member) \
    {for( TFieldIterator<UProperty,CASTCLASS_UProperty> It( FindObjectChecked<UClass>( Pre##ClassName::StaticClass()->GetOuter(), TEXT(#ClassName) ) ); It; ++It ) \
...
#define DECLARE_CLASS( TClass, TSuperClass, TStaticFlags, TPackage ) \
	DECLARE_BASE_CLASS( TClass, TSuperClass, TStaticFlags, CASTCLASS_None, TPackage ) \
...
#define DECLARE_CASTED_CLASS( TClass, TSuperClass, TStaticFlags, TPackage, TStaticCastFlags ) \
	DECLARE_BASE_CLASS( TClass, TSuperClass, TStaticFlags, TStaticCastFlags, TPackage ) \
	DECLARE_SERIALIZER_AND_DTOR( TClass ) \
	static void InternalConstructor( void* X ) \
		{ new( (EInternal*)X )TClass; }
...
#define DECLARE_ABSTRACT_CASTED_CLASS( TClass, TSuperClass, TStaticFlags, TPackage, TStaticCastFlags ) \
	DECLARE_BASE_CLASS( TClass, TSuperClass, TStaticFlags|CLASS_Abstract, TStaticCastFlags, TPackage ) \
	DECLARE_SERIALIZER_AND_DTOR( TClass )
...
#define DECLARE_ABSTRACT_CASTED_CLASS( TClass, TSuperClass, TStaticFlags, TPackage, TStaticCastFlags ) \
	DECLARE_CASTED_CLASS( TClass, TSuperClass, TStaticFlags|CLASS_Abstract, TPackage, TStaticCastFlags )
...
public:
	...
	void RetrieveReferencers( TArray<UObject*>* OutInternalReferencers, TArray<UObject*>* OutExternalReferencers, UBOOL bIncludeTransients );
