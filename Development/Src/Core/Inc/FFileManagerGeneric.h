...
#define SCOPED_FILE_IO_READ_OPEN_STATS(StatsHandle) FScopedFileIORequestStats ScopedFileIORequestStats(StatsHandle,-1,-1,FIOT_ReadOpenRequest)
...
#define SCOPED_FILE_IO_ASYNC_READ_OPEN_STATS(StatsHandle) FScopedFileIORequestStats ScopedFileIORequestStats(StatsHandle,-1,-1,FIOT_AsyncReadOpenRequest)
...
#define SCOPED_FILE_IO_WRITE_OPEN_STATS(StatsHandle) FScopedFileIORequestStats ScopedFileIORequestStats(StatsHandle,-1,-1,FIOT_WriteOpenRequest)
