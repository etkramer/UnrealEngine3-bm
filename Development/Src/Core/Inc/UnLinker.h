...
public:
	...
	*/
	...
	/**
	 * List of additional packages that are needed to be cooked for this pacakge (ie streaming levels)
	 */
...
public:
	 ...
	 */
	void GatherExportDependencies(INT ExportIndex, TSet<FDependencyRef>& Dependencies);
