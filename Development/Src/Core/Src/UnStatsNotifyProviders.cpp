	...
	DWORD StatType,DWORD GroupId)
{
	...
	// Check the stat ID range to determine whether this is a script stat or not
	NewStatDesc.bIsScriptFunctionStat = ( StatId >= STAT_FirstScriptFunctionStat && StatId <= STAT_LastScriptFunctionStat );
