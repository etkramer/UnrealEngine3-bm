...
#if PLATFORM_UNIX   // !!! FIXME: implement this...
#define gvStopDevice(x,y)
#define gvFreeDevice(x)
#define gvCleanup()
#define gvListDevices(x,y,z) (0)
#define gvNewDevice(x,y) (0)
#define gvStartup() (0)
#define gvSetSampleRate(x)
#define gvSetCodec(x) (GVFalse)
#define gvGetCodecInfo(x,y,z)
#define gvSetFilter(x,y,z)
#define gvSetCaptureThreshold(x,y)
#define gvStartDevice(x,y) (GVFalse)
#define gvSetCaptureThreshold(x,y)
#define gvStopDevice(x,y)
#define gvGetAvailableCaptureBytes(x) (0)
#define gvIsSourceTalking(x,y) (GVFalse)
#define gvCapturePacket(a,b,c,d,e) (GVFalse)
#define gvPlayPacket(a,b,c,d,e) (GVFalse)
#define gvThink()
#endif
