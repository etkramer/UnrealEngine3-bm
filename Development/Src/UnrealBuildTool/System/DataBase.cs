...
namespace UnrealBuildTool
{
	class PerfDataBase
	{
		 ...
		 */
		public static void SendBuildSummary( double Duration, Target Target, bool bSuccess, int NumActions, int NumOutDatedActions, int NumExecutedActions, string ExecutorName )
		{
			try
			{
				...
				if( BuildConfiguration.PerfDatabaseName.Length > 0 )
				{
					...
					string SqlCommandString = "EXEC dbo.AddRun_v2 ";
					SqlCommandString += String.Format(" @Duration='{0}',", Duration );
					SqlCommandString += String.Format(" @ConfigName='{0}',", Target.GetConfigurationName() );
					SqlCommandString += String.Format(" @PlatformName='{0}',", Target.GetPlatformName() );
					SqlCommandString += String.Format(" @GameName='{0}',", Target.GetTargetName() );
					...
					SqlCommandString += String.Format(" @bGeneratedDebugInfo='{0}',", Target.IsCreatingDebugInfo() );
