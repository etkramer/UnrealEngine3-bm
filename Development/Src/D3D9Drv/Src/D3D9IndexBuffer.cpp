...
FIndexBufferRHIRef FD3D9DynamicRHI::CreateIndexBuffer(UINT Stride,UINT Size,FResourceArrayInterface* ResourceArray,EResourceUsageFlag InUsage)
{
	...
	const DWORD Usage = (InUsage != RUF_Static) ? (D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY) : 0;
	const D3DPOOL Pool = (InUsage != RUF_Static) ? D3DPOOL_DEFAULT : D3DPOOL_MANAGED;
...
FIndexBufferRHIRef FD3D9DynamicRHI::CreateInstancedIndexBuffer(UINT Stride,UINT Size,EResourceUsageFlag InUsage, UINT& OutNumInstances)
{
