...
public:
    //## BEGIN PROPS GameHUD
    FLOAT TotalTitleDrawTime;
    FLOAT TotalTitleFadeTime;
    FLOAT TitleDrawStartTime;
    FStringNoInit ChapterTitleString;
    FStringNoInit ActTitleString;
    //## END PROPS GameHUD

    DECLARE_ABSTRACT_CLASS(AGameHUD,AHUD,0|CLASS_Transient|CLASS_Config,GameFramework)
    NO_DEFAULT_CONSTRUCTOR(AGameHUD)
};
...
DECLARE_NATIVE_TYPE(GameFramework,AGameHUD);
...
VERIFY_CLASS_OFFSET_NODIE(A,GameHUD,TotalTitleDrawTime)
VERIFY_CLASS_OFFSET_NODIE(A,GameHUD,ActTitleString)
VERIFY_CLASS_SIZE_NODIE(AGameHUD)
