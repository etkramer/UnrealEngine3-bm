...
#if XBOX || (_WINDOWS && !WITH_PANORAMA)
 ...
 */
FSocket* FSocketWin::Accept()
{
	SOCKET NewSocket = accept(Socket,NULL,NULL);
	if ( NewSocket != INVALID_SOCKET )
	{
		return new FSocketWin( NewSocket, SocketType );
	}
	return NULL;
}
 ...
 * @return		The new (heap-allocated) socket, or NULL if unsuccessful.
 */
FSocket* FSocketWin::Accept(FInternetIpAddr& OutAddr)
{
...
#if _WINDOWS && !WITH_PANORAMA // Xbox has it's own version of this
/**
