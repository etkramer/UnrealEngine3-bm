...
public:
    ...
    INT TessellationCheckCount;
    FLOAT TessellationCheckDistance;
    FLOAT TessellationCheckBorder;
...
struct FTerrainFoliageMesh
{
    ...
    /** Constructors */
    FTerrainFoliageMesh() {}
    FTerrainFoliageMesh(EEventParm)
    {
        appMemzero(this, sizeof(FTerrainFoliageMesh));
    }
};
...
VERIFY_CLASS_OFFSET_NODIE(A,Terrain,WireframeColor)
