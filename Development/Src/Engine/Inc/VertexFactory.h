 ...
 */
#define IMPLEMENT_VERTEX_FACTORY_TYPE(FactoryClass,ShaderParametersType,ShaderFilename,bUsedWithMaterials,bSupportsStaticLighting,bPrecisePrevWorldPos,InMinPackageVersion,InMinLicenseePackageVersion) \
