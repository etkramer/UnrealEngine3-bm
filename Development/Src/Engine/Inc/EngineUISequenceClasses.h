...
public:
    ...
    struct FUniqueNetId DataFieldNetIdValue;
...
public:
    ...
    struct FUniqueNetId CellFieldNetIdValue;
...
{
public:
    //## BEGIN PROPS UIAction_DisplaySurvey
    FStringNoInit QuestionId;
    FStringNoInit QuestionContext;
    //## END PROPS UIAction_DisplaySurvey

    DECLARE_CLASS(UUIAction_DisplaySurvey,UUIAction,0,Engine)
	/**
...
{
public:
    //## BEGIN PROPS UIAction_FocusActions
    //## END PROPS UIAction_FocusActions

    DECLARE_ABSTRACT_CLASS(UUIAction_FocusActions,UUIAction,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIAction_FocusActions)
};

class UUIAction_GetFocused : public UUIAction_FocusActions
{
public:
    //## BEGIN PROPS UIAction_GetFocused
    class UUIScreenObject* FocusedChild;
    BITFIELD bRecursiveSearch:1;
    //## END PROPS UIAction_GetFocused

    DECLARE_CLASS(UUIAction_GetFocused,UUIAction_FocusActions,0,Engine)
	/**
...
public:
    ...
    DECLARE_CLASS(UUIAction_GetLastFocused,UUIAction_FocusActions,0,Engine)
	/**
...
public:
    ...
    DECLARE_CLASS(UUIAction_SetFocus,UUIAction_FocusActions,0,Engine)
	/**
...
#define UCONST_ACTION_FAILURE_INDEX 1
#define UCONST_ACTION_SUCCESS_INDEX 0
...
class UUIAction_InsertScene : public UUIAction_OpenScene
{
public:
    //## BEGIN PROPS UIAction_InsertScene
    INT DesiredInsertIndex;
    INT ActualInsertIndex;
    //## END PROPS UIAction_InsertScene

    DECLARE_CLASS(UUIAction_InsertScene,UUIAction_OpenScene,0,Engine)
	/* === USequenceOp interface === */
	/**
...
class UUIAction_ReplaceScene : public UUIAction_OpenScene
{
public:
    //## BEGIN PROPS UIAction_ReplaceScene
    class UUIScene* SceneInstanceToReplace;
    //## END PROPS UIAction_ReplaceScene

    DECLARE_CLASS(UUIAction_ReplaceScene,UUIAction_OpenScene,0,Engine)
	/* === USequenceOp interface === */
	/**
...
public:
    ...
    FStringNoInit TempStringReturnValue;
...
{
public:
    //## BEGIN PROPS UICond_IsFocused
    //## END PROPS UICond_IsFocused

    DECLARE_CLASS(UUICond_IsFocused,USequenceCondition,0,Engine)
	/**
...
{
public:
    //## BEGIN PROPS UIEvent_CalloutButtonInputProxy
    class UUICalloutButtonPanel* ButtonPanel;
    //## END PROPS UIEvent_CalloutButtonInputProxy

    UBOOL RegisterButtonAlias(FName ButtonAliasName);
    UBOOL UnregisterButtonAlias(FName ButtonAliasName);
    UBOOL ChangeButtonAlias(FName CurrentAliasName,FName NewAliasName);
    INT FindButtonAliasIndex(FName ButtonAliasName) const;
    DECLARE_FUNCTION(execRegisterButtonAlias)
    {
        P_GET_NAME(ButtonAliasName);
        P_FINISH;
        *(UBOOL*)Result=RegisterButtonAlias(ButtonAliasName);
    }
    DECLARE_FUNCTION(execUnregisterButtonAlias)
    {
        P_GET_NAME(ButtonAliasName);
        P_FINISH;
        *(UBOOL*)Result=UnregisterButtonAlias(ButtonAliasName);
    }
    DECLARE_FUNCTION(execChangeButtonAlias)
    {
        P_GET_NAME(CurrentAliasName);
        P_GET_NAME(NewAliasName);
        P_FINISH;
        *(UBOOL*)Result=ChangeButtonAlias(CurrentAliasName,NewAliasName);
    }
    DECLARE_FUNCTION(execFindButtonAliasIndex)
    {
        P_GET_NAME(ButtonAliasName);
        P_FINISH;
        *(INT*)Result=FindButtonAliasIndex(ButtonAliasName);
    }
    DECLARE_CLASS(UUIEvent_CalloutButtonInputProxy,UUIEvent,0,Engine)
	/* === USequenceOp interface === */
	/**
...
{
public:
    //## BEGIN PROPS SeqVar_UniqueNetId
    struct FUniqueNetId NetIdValue;
    //## END PROPS SeqVar_UniqueNetId

    DECLARE_CLASS(USeqVar_UniqueNetId,USequenceVariable,0,Engine)
...
AUTOGENERATE_FUNCTION(UUIEvent_CalloutButtonInputProxy,-1,execFindButtonAliasIndex);
AUTOGENERATE_FUNCTION(UUIEvent_CalloutButtonInputProxy,-1,execChangeButtonAlias);
AUTOGENERATE_FUNCTION(UUIEvent_CalloutButtonInputProxy,-1,execUnregisterButtonAlias);
AUTOGENERATE_FUNCTION(UUIEvent_CalloutButtonInputProxy,-1,execRegisterButtonAlias);
...
DECLARE_NATIVE_TYPE(Engine,USeqVar_UniqueNetId);
...
DECLARE_NATIVE_TYPE(Engine,UUIAction_InsertScene);
...
DECLARE_NATIVE_TYPE(Engine,UUIAction_ReplaceScene);
...
DECLARE_NATIVE_TYPE(Engine,UUICond_IsFocused);
DECLARE_NATIVE_TYPE(Engine,UUIEvent);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_CalloutButtonInputProxy);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE_UISEQUENCE \
	...
	USeqVar_UniqueNetId::StaticClass(); \
	...
	UUIAction_InsertScene::StaticClass(); \
	...
	UUIAction_ReplaceScene::StaticClass(); \
...
NATIVE_INFO(UUIEvent_CalloutButtonInputProxy) GEngineUUIEvent_CalloutButtonInputProxyNatives[] = 
{ 
	MAP_NATIVE(UUIEvent_CalloutButtonInputProxy,execFindButtonAliasIndex)
	MAP_NATIVE(UUIEvent_CalloutButtonInputProxy,execChangeButtonAlias)
	MAP_NATIVE(UUIEvent_CalloutButtonInputProxy,execUnregisterButtonAlias)
	MAP_NATIVE(UUIEvent_CalloutButtonInputProxy,execRegisterButtonAlias)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UUIEvent_CalloutButtonInputProxy);
...
VERIFY_CLASS_OFFSET_NODIE(U,SeqVar_UniqueNetId,NetIdValue)
VERIFY_CLASS_SIZE_NODIE(USeqVar_UniqueNetId)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_DisplaySurvey,QuestionId)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_DisplaySurvey,QuestionContext)
VERIFY_CLASS_SIZE_NODIE(UUIAction_DisplaySurvey)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_FindOnlineGames,DataStoreName)
VERIFY_CLASS_SIZE_NODIE(UUIAction_FindOnlineGames)
VERIFY_CLASS_SIZE_NODIE(UUIAction_FocusActions)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_GetCellValue,CollectionIndex)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_GetCellValue,CellFieldNetIdValue)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_GetDatafieldValue,DataFieldNetIdValue)
VERIFY_CLASS_SIZE_NODIE(UUIAction_GetDatafieldValue)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_GetFocused,FocusedChild)
VERIFY_CLASS_SIZE_NODIE(UUIAction_GetFocused)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_InsertScene,DesiredInsertIndex)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_InsertScene,ActualInsertIndex)
VERIFY_CLASS_SIZE_NODIE(UUIAction_InsertScene)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_ReplaceScene,SceneInstanceToReplace)
VERIFY_CLASS_SIZE_NODIE(UUIAction_ReplaceScene)
VERIFY_CLASS_SIZE_NODIE(UUIAction_SaveProfileSettings)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_Scene,Scene)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_Scene,ForcedScenePriority)
VERIFY_CLASS_SIZE_NODIE(UUIAction_Scene)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_SetDatafieldValue,DataFieldStringValue)
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_SetDatafieldValue,DataFieldNetIdValue)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_ShowKeyboardUI,TempStringReturnValue)
VERIFY_CLASS_SIZE_NODIE(UUIAction_ShowKeyboardUI)
VERIFY_CLASS_SIZE_NODIE(UUIAction_ShowLoginUI)
VERIFY_CLASS_SIZE_NODIE(UUICond_IsFocused)
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent,SubobjectVersionModifier)
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent,__AllowEventActivation__Delegate)
VERIFY_CLASS_SIZE_NODIE(UUIEvent)
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent_CalloutButtonInputProxy,ButtonPanel)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_CalloutButtonInputProxy)
