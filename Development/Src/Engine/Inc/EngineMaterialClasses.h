...
class UMaterialExpressionAddNormalMap : public UMaterialExpression
{
public:
    //## BEGIN PROPS MaterialExpressionAddNormalMap
    ...
    //## END PROPS MaterialExpressionAddNormalMap

    DECLARE_CLASS(UMaterialExpressionAddNormalMap,UMaterialExpression,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionAddNormalMap)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionLightingDiffuseLambert)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionLightingSpecularBlinnPhong)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionLightingSpecularHeidrichSeidel)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionLightingSpecularPhong)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionMax)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionMin)
};
...
class UMaterialExpressionNormal : public UMaterialExpression
{
public:
    //## BEGIN PROPS MaterialExpressionNormal
    //## END PROPS MaterialExpressionNormal

    DECLARE_CLASS(UMaterialExpressionNormal,UMaterialExpression,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UMaterialExpressionNormal)
};
...
public:
    ...
    {
        P_FINISH;
        *(UBOOL*)Result=IsInMapOrTransientPackage();
    }
...
public:
    ...
    virtual void SetTextureParameterValue(FName ParameterName,class UTexture* Value);
    virtual void SetVectorParameterValue(FName ParameterName,FLinearColor Value);
    virtual void SetVectorCurveParameterValue(FName ParameterName,FInterpCurveVector Value);
    ...
    {
        P_GET_NAME(ParameterName);
        P_GET_STRUCT_INIT(FInterpCurveVector,Value);
        P_FINISH;
        SetVectorCurveParameterValue(ParameterName,Value);
    }
    DECLARE_FUNCTION(execSetVectorStartTime)
    {
        ...
        P_GET_FLOAT(Value);
        P_FINISH;
        SetVectorStartTime(ParameterName,Value);
    }
    DECLARE_FUNCTION(execGetMaxDurationFromAllParameters)
    {
        P_FINISH;
        *(FLOAT*)Result=GetMaxDurationFromAllParameters();
    }
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionAddNormalMap);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionConstantBiasScale);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionDeriveNormalZ);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionDynamicParameter);
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionFlipBookSample);
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionFloor);
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionFluidNormal);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionMax);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionMin);
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionMultiply);
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionNormal);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionTextureSampleParameterSubUV);
...
DECLARE_NATIVE_TYPE(Engine,UMaterialExpressionWorldPosition);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE_MATERIAL \
	...
	UMaterialExpressionAddNormalMap::StaticClass(); \
	...
	UMaterialExpressionNormal::StaticClass(); \
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionAddNormalMap,Texture)
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionAddNormalMap,Base)
VERIFY_CLASS_SIZE_NODIE(UMaterialExpressionAddNormalMap)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionConstantBiasScale,Input)
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionConstantBiasScale,Scale)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionDeriveNormalZ,InXY)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionDynamicParameter,ParamNames)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionMax,A)
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionMax,B)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionMin,A)
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionMin,B)
...
VERIFY_CLASS_SIZE_NODIE(UMaterialExpressionNormal)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionParameter,ParameterName)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionStaticComponentMaskParameter,Input)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionStaticSwitchParameter,A)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialExpressionTextureCoordinate,VTiling)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialInstance,ReferencedTextures)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialInstanceTimeVarying,Duration)
