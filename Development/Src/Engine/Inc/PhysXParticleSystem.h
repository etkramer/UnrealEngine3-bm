...
#define PHYSX_PARTICLE_SYSTEM_DEBUG_IDS 0
...
public:
	...
	TArray<INT> DebugDelAsyncIds;
	TArray<INT> DebugDelSdkIds;
#endif
	...
	FORCEINLINE void RemoveParticle(UINT Id, UINT IdToFix)
	{
		...
		check(NumParticleFlagUpdates < Params.MaxParticles);
...
private:
	...
	BOOL GetLODOrigin(FVector&);
	BOOL GetLODNearClippingPlane(FPlane&);
