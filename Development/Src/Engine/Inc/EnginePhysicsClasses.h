...
public:
    ...
    class USoundCue* BodyfallSound;
    class USoundCue* GenericSound;
...
VERIFY_CLASS_OFFSET_NODIE(A,KAsset,ImpactForceComponent)
...
VERIFY_CLASS_OFFSET_NODIE(U,PhysicsAssetInstance,CachedDampingRampupProportion)
