...
public:
	...
	BOOL RemoveParticleById(WORD Id, QueueParticle& Removed, BYTE* InIndexBase, UINT InIndexStride);
	BOOL RemoveParticleById(WORD Id, BYTE* InIndexBase, UINT InIndexStride);
	BOOL RemoveParticle(WORD HeapIndex, QueueParticle& Removed, BYTE* InIndexBase, UINT InIndexStride);
	BOOL RemoveParticle(QueueParticle& Removed, BYTE* InIndexBase, UINT InIndexStride);
	FLOAT RemoveParticles(WORD NumParticles, BYTE* InIndexBase, UINT InIndexStride);
	BOOL Front(QueueParticle& Removed);
	void Clear();
	INT Num();
