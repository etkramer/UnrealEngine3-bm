...
{
	DECLARE_CLASS(UFracturedStaticMesh,UStaticMesh,CLASS_SafeReplace|CLASS_CollapseCategories|CLASS_Intrinsic,Engine);
public:
...
private:
	...
	friend void MergeStaticMesh(UStaticMesh* DestMesh, UStaticMesh* SourceMesh, const FVector& InOffset, const FRotator& InRotation, FLOAT ScaleFactor, const FVector& ScaleFactor3D);
};
