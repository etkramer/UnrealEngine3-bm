...
void UFluidSurfaceComponent::PostEditChange(UProperty* PropertyThatChanged)
{
...
void UFluidSurfaceComponent::GetLightMapResolution( INT& Width, INT& Height ) const
{
