...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLensFlareVertexFactory,FLensFlareVertexFactoryShaderParameters,"LensFlareVertexFactory",TRUE,FALSE,FALSE, VER_CONTENT_RESAVE_AUGUST_2007_QA_BUILD,0);
