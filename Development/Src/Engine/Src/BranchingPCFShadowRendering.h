...
public:
	...
	{
		return Platform == SP_PCD3D_SM4 || Platform == SP_PCD3D_SM3 || Platform == SP_PS3;
	}
};
...
public:
	...
	static UBOOL ShouldCache(EShaderPlatform Platform)
	{
		return Platform == SP_PCD3D_SM4 || Platform == SP_PCD3D_SM3;
	}
};
...
*/
	...
	*/
		...
		)
	{
		...
		{
			SceneTextureParams.Set(&View,this, SF_Point, GSceneRenderTargets.GetSceneColorRawTexture());
		}
		else
		{
...
*/
extern FGlobalBoundShaderState* ChooseBPCFBoundShaderState(
	BYTE LightShadowQuality,
	FGlobalBoundShaderState* LowQualityBoundShaderState,
	FGlobalBoundShaderState* MediumQualityBoundShaderState,
	FGlobalBoundShaderState* HighQualityBoundShaderState);
