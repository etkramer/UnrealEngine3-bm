...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLocalVertexFactory,FLocalVertexFactoryShaderParameters,"LocalVertexFactory",TRUE,TRUE,TRUE, VER_CONTENT_RESAVE_AUGUST_2007_QA_BUILD,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FLocalShadowVertexFactory,FLocalVertexFactoryShaderParameters,"LocalVertexFactory",FALSE,FALSE,FALSE, VER_CONTENT_RESAVE_AUGUST_2007_QA_BUILD,0);
