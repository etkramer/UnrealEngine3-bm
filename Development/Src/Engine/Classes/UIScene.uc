 ...
 */
var(Controls)	const				class<UIToolTip>		DefaultToolTipClass<ToolTip=The class that should be used for tooltips in this scene>;
 ...
 */
var const transient	native private	LookupMap_Mirror		DockingStack{TLookupMap<FUIDockingNode>};
