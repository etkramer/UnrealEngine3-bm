...
struct immutablewhencooked native LinkSlotHelper
{
...
struct immutablewhencooked native TargetInfo
{
	var Actor	Target;
...
{
	/** CT_Standing/CT_MidLevel for source marker */
	var ECoverType		SrcType;
	/** Action for source marker */
...
{
	/** Target slot marker */
	var() editconst const ActorReference TargetMarker;

	/** List of fire link items */
	var array<FireLinkItem>	Items;

	/** Location of the TargetMarker when this FireLink was created/updated (Used for tracking CoverLink_Dynamic) */
	var Vector LastTargetMarkerLocation;
	/** Location of the SrcMarker when this FireLink was created/updated (Used for tracking CoverLink_Dynamic) */
	var Vector LastSrcMarkerLocation;
...
{
	/** Slot marker that is dangerous to this link */
	var() editconst const ActorReference	TargetMarker;
...
struct immutablewhencooked native CoverSlot
{
	...
	var() duplicatetransient array<ExposedLink>		ExposedFireLinks;
	/** List of nav points that are dangerous to path through when this slot is occupied */
	var() duplicatetransient array<DangerLink>		DangerLinks;
...
defaultproperties
{
	...
	Begin Object NAME=Sprite
		Sprite=Texture2D'EditorResources.CoverNodeNone'
	End Object
