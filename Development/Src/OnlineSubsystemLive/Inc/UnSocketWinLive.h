...
public:
	 ...
	 */
	FSocketWinLive(SOCKET InSocket,ESocketType InSocketType) :
		FSocketWin(InSocket,InSocketType)
	{
	}
	/**
	 * Closes the socket
	 ...
	 * @return		The new (heap-allocated) socket, or NULL if unsuccessful.
	 */
	virtual FSocket* Accept(FInternetIpAddr& OutAddr);
	/**
