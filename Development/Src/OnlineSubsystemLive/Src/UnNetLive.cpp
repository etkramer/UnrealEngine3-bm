...
#if CONSOLE
	#if _DEBUG
		#pragma message("Linking DEBUG XHV via xhv.lib")
		#pragma comment(lib,"xhvd.lib")
	#else
		#pragma message("Linking XHV via xhv.lib")
		#pragma comment(lib,"xhv.lib")
	#endif
#endif
	...
	INT InPacketOverhead)
{
	...
	bIsServer = InDriver->ServerConnection == NULL;
