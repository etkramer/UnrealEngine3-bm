/**
 * WarGameAnnex
 * Warfare Game Info for CTM Gametype
 *
 * Copyright 1998-2008 Epic Games, Inc. All Rights Reserved.
 */
class GearGameCTM extends GearGameCTM_Base;

/** Set the ring's color */
function SetCTMRingColor( Color RingColor )
{
	Emit_AnnexArc(DestinationEffect).SetAnnexColor( RingColor );
}

defaultproperties
{
	MeatflagClasses(0)=class'GearGameContent.GearPawn_MeatflagFranklin'
	MeatflagClasses(1)=class'GearGameContent.GearPawn_MeatflagOldMan'
	MeatflagClasses(2)=class'GearGameContent.GearPawn_MeatflagDrunk'

	HUDType=class'GearGameContent.GearHUDCTM'
	DestinationEffectClass=class'Emit_AnnexArc'

	Sound_ControllingTeamChanged(0)=SoundCue'DLC_Annex.Annex.TeamControlChangedCogCue'
	Sound_ControllingTeamChanged(1)=SoundCue'DLC_Annex.Annex.TeamControlChangedLocCue'
	Sound_VictimDropped(0)=SoundCue'DLC_Annex.Annex.CommandPointBrokenCogCue'
	Sound_VictimDropped(1)=SoundCue'DLC_Annex.Annex.CommandPointBrokenLocCue'
	Sound_DestinationExpired(0)=SoundCue'DLC_Annex.Annex.CommandPointMovesCogCue'
	Sound_DestinationExpired(1)=SoundCue'DLC_Annex.Annex.CommandPointMovesCogCue'
