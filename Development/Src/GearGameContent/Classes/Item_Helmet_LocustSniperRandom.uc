...
class Item_Helmet_LocustSniperRandom extends Item_HelmetBase;
...
defaultproperties
{
	SpawnableClassesData.Add( ( PercentageToSpawn=0.5f, ItemClass=class'Item_Helmet_LocustDroneSniper' ) )
