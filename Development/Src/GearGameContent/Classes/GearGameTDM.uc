 ...
 */
class GearGameTDM extends GearGameTDM_Base;

defaultproperties
{
	HUDType=class'GearGameContent.GearHUDTDM'
	...
	EncouragementData(ET_WonMatchByShutout)={(
		CogSounds=(SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_HumanSpiritAtFinest01Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_TextbookDeployment01Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_ViolentWrecklessGoodWork01Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_CongratulationsExcellentWork02Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_DeadThatsWhatILikeToSee01Cue'),
	...
	EncouragementData(ET_LostMatch)={(
		CogSounds=(SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_WhyUnderstandYourInadequacies01Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_GreatAuntRosemaryKnowsWeapons01Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_ClassicExampleOfWhatNotToDo02Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_GearsSoldiersDecimated02Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_ThatWasAMockery01Cue'),
	...
	EncouragementData(ET_WonRound)={(
		CogSounds=(SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_DontJustDefeatDestroy01Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_PreciseEfficientAndLethal01Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_YoureNotDone01Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_HonoredToHaveGearsLikeYou02Cue',SoundCue'Human_Prescott_Dialog_Cue.WinsBattleWithLocust.ChairmanChatter_ThatsWhatILikeToSee02Cue'),
	...
	EncouragementData(ET_LostRound)={(
		CogSounds=(SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_TeamEffortLiveDieTogether02Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_ThinkAboutMomDad01Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_FinestGearsStartActingLikeIt02Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_NeverWinWithFailuresLikeYou01Cue',SoundCue'Human_Prescott_Dialog_Cue.LosesBattleWithLocust.ChairmanChatter_YouDecideWinnerOrLoser02Cue'),
