...
simulated function DrawPlayerNum(UTPlayerReplicationInfo PRI,int PIndex, out float YPos, float FontIndex, float FontScale)
{
	...
	if ( PRI.bIsHero )
	{
		...
		Canvas.DrawTile(HeroTexture, W, H, HeroCoords.U, HeroCoords.V, HeroCoords.UL, HeroCoords.VL);
		Canvas.DrawColor = C;
	}
...
defaultproperties
{
	...
	HeroTexture=Texture2D'UI_HUD.HUD.UI_HUD_BaseA'
	HeroCoords=(U=463,V=397,UL=22,VL=25)
