...
class AICmd_Hover_MoveToGoal extends AICommand;
...
var vector MoveVectDest;

var ReachSpec CurrentSpec;
/** GoW global macros */

/** Simple constructor that pushes a new instance of the command for the AI */
static function bool MoveToGoal( GearAI AI, Actor InGoal, float InGoalDistance, float InHoverHeight )
{
	local AICmd_Hover_MoveToGoal Cmd;

	if( AI != None && AI.Pawn != None && AI.Pawn.bCanFly)
	{
		Cmd = new(AI) class'AICmd_Hover_MoveToGoal';
		if( Cmd != None )
		{
