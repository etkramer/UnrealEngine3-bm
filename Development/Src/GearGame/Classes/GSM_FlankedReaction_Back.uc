...
class GSM_FlankedReaction_Back extends GearSpecialMove;

var()	GearPawn.BodyStance	BS_Animation;

protected function bool InternalCanDoSpecialMove()
{
	return (PawnOwner.CarriedCrate == None && Super.InternalCanDoSpecialMove());
}
...
function SpecialMoveStarted(bool bForced, ESpecialMove PrevMove)
{
	...
	// Force Pawn into aiming stance for animation blend out.
	PawnOwner.SetWeaponAlert(5.f);
}
...
defaultproperties
{
	BS_Animation=(AnimName[BS_FullBody]="AR_FlankSurprise_Back")
