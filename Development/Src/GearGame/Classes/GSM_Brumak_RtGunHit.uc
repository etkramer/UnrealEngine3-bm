...
class GSM_Brumak_RtGunHit extends GSM_Brumak_BasePlaySingleAnim;
...
defaultproperties
{
	BS_Animation=(AnimName[BS_Std_Up]="right_gun_hit",AnimName[BS_Std_Idle_Lower]="right_gun_hit")
	BlendInTime=0.33f
	BlendOutTime=0.67f

	NearbyPlayerSynchedCameraAnimName="Rt_Arm_Damage_Brumak"
}