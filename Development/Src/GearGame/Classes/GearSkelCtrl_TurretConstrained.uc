...
class GearSkelCtrl_TurretConstrained extends SkelControlSingleBone
	native(Anim);
...
/** If TRUE, zero out any rotation component (yaw, pitch, roll) which is completely constrained. */
var(Constraint)	bool bZeroCompletelyConstrained;
