 ...
 */
class GearLeaderboardSettingsPrivate extends GearLeaderboardSettingsBase;
...
defaultproperties
{
	...
	LocalizedSettingsMappings(LF_PlayerFilterType)=(Id=LF_PlayerFilterType,Name="Player Filter",ValueMappings=((Id=PF_Friends)))
}
