...
/**
 * Writes the annex specific leaderboards
 */
class GearLeaderboardWriteAnnex extends GearLeaderboardVersusWrite;
...
function UpdateFromPRI(GearPRI PRI,int RoundsPlayed,int RoundsWon,int RoundsLost)
{
	...
	SetIntStat(PROPERTY_RINGCAPTURE,PRI.Score_GameSpecific1);
	SetIntStat(PROPERTY_RINGBREAK,PRI.Score_GameSpecific2);
}

defaultproperties
{
	// The leaderboards the properties are written to
	ViewIds=(STATS_VIEW_ANNEXALLTIMEPRIVATE)
	ArbitratedViewIds=(STATS_VIEW_ANNEXDAILY,STATS_VIEW_ANNEXWEEKLY,STATS_VIEW_ANNEXMONTHLY,STATS_VIEW_ANNEXALLTIME)

	// These are the stats we are collecting
	Properties=((PropertyId=PROPERTY_RINGBREAK,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_RINGCAPTURE,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_MATCHESPLAYED,Data=(Type=SDT_Int32,Value1=1)),(PropertyId=PROPERTY_MATCHESWON,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_MATCHESLOST,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_ROUNDSPLAYED,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_ROUNDSWON,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_ROUNDSLOST,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_ROUNDSDRAW,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_KILLS,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_DEATHS,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_REVIVES,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_TAKEDOWNS,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_POINTS,Data=(Type=SDT_Int32,Value1=0)),(PropertyId=PROPERTY_POINTSRATED,Data=(Type=SDT_Int32,Value1=0)))
}