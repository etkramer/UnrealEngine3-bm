...
{
	DECLARE_CLASS(UMaterialFactory,UFactory,0,Editor);
public:
	/**
	 * Initializes property values for intrinsic classes.  It is called immediately after the class default object
	 * is initialized against its archetype, but before any objects of this class are created.
...
{
	DECLARE_CLASS(UPackageFactory,UFactory,0,Editor)
	UPackageFactory();
	/**
	 * Initializes property values for intrinsic classes.  It is called immediately after the class default object
	 * is initialized against its archetype, but before any objects of this class are created.
...
{
	DECLARE_CLASS( USoundModeFactory, UFactory, 0, Editor )
...
{
	DECLARE_CLASS(UPhysXParticleSystemFactoryNew,UFactory,0,Editor)
	void StaticConstructor();
	/**
	 * Initializes property values for intrinsic classes.  It is called immediately after the class default object
	 * is initialized against its archetype, but before any objects of this class are created.
