...
public:
	...
	/** Constructor */
	FCameraControllerConfig()
		: ImpulseDeadZoneAmount( 0.01f ),
		  bUsePhysicsBasedMovement( TRUE ),	  
		  MovementAccelerationRate( 20000.0f ),
		  MovementVelocityDampingAmount( 12.0f ),
		  MaximumMovementSpeed( 1200.0f ),
		  bUsePhysicsBasedRotation( FALSE ),	  
		  RotationAccelerationRate( 30000.0f ),
		  RotationVelocityDampingAmount( 12.0f ),
		  MaximumRotationSpeed( 1080.0f ),
...
public:
	...
	const FCameraControllerConfig& GetConfig() const
	{
		return Config;
	}
