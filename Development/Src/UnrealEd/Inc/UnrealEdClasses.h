...
public:
    ...
    DECLARE_CLASS(UASVSkelComponent,USkeletalMeshComponent,0|CLASS_Transient,UnrealEd)
	// UPrimitiveComponent interface.
...
{
public:
    //## BEGIN PROPS GenericBrowserType_MaterialLackingPhysMat
    //## END PROPS GenericBrowserType_MaterialLackingPhysMat

    DECLARE_CLASS(UGenericBrowserType_MaterialLackingPhysMat,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
};
...
public:
    ...
    DECLARE_CLASS(UGenericBrowserType_SoundMode,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
};
...
{
    BITFIELD ParameterValue:1 GCC_BITFIELD_MAGIC;
...
struct FPhysXSlicingParameters
{
    ...
    INT SlicesInZ;
    FVector LinearNoise;
    FVector AngularNoise;

    /** Constructors */
    FPhysXSlicingParameters() {}
    FPhysXSlicingParameters(EEventParm)
    {
        appMemzero(this, sizeof(FPhysXSlicingParameters));
    }
};
...
{
public:
    //## BEGIN PROPS PhysXFractureOptions
    TArrayNoInit<struct FPhysXSlicingParameters> SlicingLevels;
    //## END PROPS PhysXFractureOptions

    DECLARE_CLASS(UPhysXFractureOptions,UObject,0,UnrealEd)
    static const TCHAR* StaticConfigName() {return TEXT("Editor");}

    NO_DEFAULT_CONSTRUCTOR(UPhysXFractureOptions)
};
...
{
public:
    //## BEGIN PROPS PhysXDestructibleLabelRenderer
    //## END PROPS PhysXDestructibleLabelRenderer

    DECLARE_CLASS(UPhysXDestructibleLabelRenderer,UThumbnailLabelRenderer,0,UnrealEd)
protected:
	/**
...
class UEditorUISceneClient : public UUISceneClient, public FCallbackEventDevice
{
public:
...
struct FUITitleRegions
{
    ...
    /** Constructors */
    FUITitleRegions() {}
    FUITitleRegions(EEventParm)
    {
        appMemzero(this, sizeof(FUITitleRegions));
    }
};
...
DECLARE_NATIVE_TYPE(UnrealEd,UFracturedStaticMeshLabelRenderer);
...
DECLARE_NATIVE_TYPE(UnrealEd,UGenericBrowserType_FracturedStaticMesh);
...
DECLARE_NATIVE_TYPE(UnrealEd,UGenericBrowserType_MaterialLackingPhysMat);
...
DECLARE_NATIVE_TYPE(UnrealEd,UGenericBrowserType_SoundMode);
...
DECLARE_NATIVE_TYPE(UnrealEd,UInterpTrackParticleReplayHelper);
...
DECLARE_NATIVE_TYPE(UnrealEd,UInterpTrackVisibilityHelper);
DECLARE_NATIVE_TYPE(UnrealEd,UKismetBindings);
DECLARE_NATIVE_TYPE(UnrealEd,ULensFlareEditorOptions);
DECLARE_NATIVE_TYPE(UnrealEd,ULensFlareEditorPropertyWrapper);
...
DECLARE_NATIVE_TYPE(UnrealEd,UParticleSystemLabelRenderer);
...
DECLARE_NATIVE_TYPE(UnrealEd,UPhysXDestructibleLabelRenderer);
DECLARE_NATIVE_TYPE(UnrealEd,UPhysXFractureOptions);
...
#define AUTO_INITIALIZE_REGISTRANTS_UNREALED \
	...
	UGenericBrowserType_MaterialLackingPhysMat::StaticClass(); \
	...
	UPhysXDestructibleLabelRenderer::StaticClass(); \
	UPhysXFractureOptions::StaticClass(); \
...
VERIFY_CLASS_OFFSET_NODIE(U,ASVSkelComponent,BoneColor)
...
VERIFY_CLASS_OFFSET_NODIE(U,CascadeOptions,ModuleMenu_ModuleRejections)
...
VERIFY_CLASS_SIZE_NODIE(UGenericBrowserType_MaterialLackingPhysMat)
...
VERIFY_CLASS_OFFSET_NODIE(U,LensFlareEditorPropertyWrapper,Element)
VERIFY_CLASS_OFFSET_NODIE(U,LensFlareEditorPropertyWrapper,ElementIndex)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialEditorInstanceConstant,VisibleExpressions)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialEditorInstanceTimeVarying,VisibleExpressions)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialEditorOptions,FavoriteExpressions)
...
VERIFY_CLASS_SIZE_NODIE(UPhysXDestructibleLabelRenderer)
VERIFY_CLASS_OFFSET_NODIE(U,PhysXFractureOptions,SlicingLevels)
VERIFY_CLASS_SIZE_NODIE(UPhysXFractureOptions)
