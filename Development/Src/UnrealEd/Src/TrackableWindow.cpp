...
EVT_HOTKEY(ID_POPUP_CTRLTAB, WxTrackableWindow::OnCtrlTab)
EVT_HOTKEY(ID_POPUP_CTRLSHIFTTAB, WxTrackableWindow::OnCtrlTab)
END_EVENT_TABLE()
 ...
 * @param	Event		Information about the event.
 */
void WxTrackableWindow::OnCtrlTab(wxKeyEvent& Event)
{
...
EVT_HOTKEY(ID_POPUP_CTRLTAB, WxTrackableFrame::OnCtrlTab)
EVT_HOTKEY(ID_POPUP_CTRLSHIFTTAB, WxTrackableFrame::OnCtrlTab)
END_EVENT_TABLE()
 ...
 * @param	Event		Information about the event.
 */
void WxTrackableFrame::OnCtrlTab(wxKeyEvent& Event)
{
	WxTrackableWindowBase::HandleCtrlTab(GApp->EditorFrame, Event.ShiftDown());
...
EVT_HOTKEY(ID_POPUP_CTRLTAB, WxTrackableDialog::OnCtrlTab)
EVT_HOTKEY(ID_POPUP_CTRLSHIFTTAB, WxTrackableDialog::OnCtrlTab)
END_EVENT_TABLE()
 ...
 * @param	Event		Information about the event.
 */
void WxTrackableDialog::OnCtrlTab(wxKeyEvent& Event)
{
	WxTrackableWindowBase::HandleCtrlTab(GApp->EditorFrame, Event.ShiftDown());
...
WxCtrlTabDialog::WxCtrlTabDialog(wxWindow *Parent, UBOOL bIsShiftDown)
	: wxDialog(Parent, -1, TEXT(""), wxPoint(100, 100), wxSize(1, 1), wxSIMPLE_BORDER | wxFRAME_NO_TASKBAR), bHasBeenSized(FALSE), CurrentlySelectedIndex(0)
{
