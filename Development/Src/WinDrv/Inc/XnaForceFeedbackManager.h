...
{
#if XBOX
	DECLARE_CLASS(UXnaForceFeedbackManager,UForceFeedbackManager,CLASS_Config|CLASS_Transient|CLASS_Intrinsic,XeDrv)
#else
	DECLARE_CLASS(UXnaForceFeedbackManager,UForceFeedbackManager,CLASS_Config|CLASS_Transient|CLASS_Intrinsic,WinDrv)
#endif
