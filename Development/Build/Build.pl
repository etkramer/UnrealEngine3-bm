...
$xenonXDKVersion     = "5632"; # the version of the Xenon XDK that we are using

$doBuildPS3          = 1;    # build PS3? effectively 0 if doBuild is 0
$PS3SDKVersion       = "160.008"; # the version of the PS3 SDK that we are using
...
$doDelayedBuild      = 1;    # if we are doing delayedBuild we will not updated the latestUnrealEngine3_<GameName> label and instead let a vetting process do that.
...
sub setVersion
{
	...
	$announceSubjectWarfare = $announceSubject;
        $announceSubjectGear = "New Gears Build: $version";
...
sub setAnnounceMailHeaderText
{
  ...
  $announceMailHeaderText = 
    ...
    "\n$buildSyncBatchFile\n\n".
    "This latest approved build will be labeled per game: ".'@'." latestUnrealEngine3_Envy or latestUnrealEngine3_Delta or latestUnrealEngine3_Gears2\n\n".
