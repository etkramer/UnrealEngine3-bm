...
#ifndef __AG_PERFMON_PHYSX___
#define __AG_PERFMON_PHYSX___
...
extern AgEventID	gPerfMonSimulate;
extern AgEventID	gPerfMonFetchResults;

#endif // AG_PERFMON

#endif // __AG_PERFMON_PHYSX___
