...
HRESULT PrepareAudio()
{
    ...
    g_audioState.iNumDroidDestroyedCueInstances = g_audioState.pEngine->GetGlobalVariableIndex( "NumDroidDestroyedCueInstances" );
...
HRESULT UpdateAudio()
{
    ...
    if( g_audioState.bUse3DAudio && g_audioState.nFrameToApply3DAudio == 0 )
    {
        ...
        g_audioState.emitter.Position = D3DXVECTOR3(0,0,0);
        V( XACT3DCalculate( g_audioState.x3DInstance, &g_audioState.listener, &g_audioState.emitter, &g_audioState.dspSettings ) );
