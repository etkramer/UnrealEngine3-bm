...
//	Normal = normalize( Normal );
    ...
    if( g_bUseSpecular )
    {
        float LumS = pow( max( 0.0f, dot( Normal, normalize( VtL0 ) ) ), g_matPower ) +
                     pow( max( 0.0f, dot( Normal, normalize( VtL1 ) ) ), g_matPower ) +
                     pow( max( 0.0f, dot( Normal, normalize( VtL2 ) ) ), g_matPower ) +
                     pow( max( 0.0f, dot( Normal, normalize( VtL3 ) ) ), g_matPower ) ;
