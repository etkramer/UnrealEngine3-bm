...
m_MaxManagedMemory(1024*1024*32),
...
// Texture functions
//--------------------------------------------------------------------------------------
ID3D10ShaderResourceView* CResourceReuseCache::GetFreeTexture10( UINT Width, UINT Height, UINT MipLevels, UINT Format, ID3D10Texture2D** ppStaging10 )
{
