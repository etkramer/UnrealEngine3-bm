...
void	CALLBACK CreateTextureFromFile9_Serial( IDirect3DDevice9* pDev, WCHAR* szFileName, IDirect3DTexture9** ppTexture, void* pContext );
void	CALLBACK CreateVertexBuffer9_Serial( IDirect3DDevice9* pDev, IDirect3DVertexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, DWORD FVF, D3DPOOL Pool, void* pData, void* pContext );
void	CALLBACK CreateIndexBuffer9_Serial( IDirect3DDevice9* pDev, IDirect3DIndexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, D3DFORMAT ibFormat, D3DPOOL Pool, void* pData, void* pContext );
void	CALLBACK CreateTextureFromFile9_Async( IDirect3DDevice9* pDev, WCHAR* szFileName, IDirect3DTexture9** ppTexture, void* pContext );
void	CALLBACK CreateVertexBuffer9_Async( IDirect3DDevice9* pDev, IDirect3DVertexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, DWORD FVF, D3DPOOL Pool, void* pData, void* pContext );
void	CALLBACK CreateIndexBuffer9_Async( IDirect3DDevice9* pDev, IDirect3DIndexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, D3DFORMAT ibFormat, D3DPOOL Pool, void* pData, void* pContext );
    ...
    for( int i=0; i<g_VisibleItemArray.GetSize(); i++ )
    {
        ...
        if( pItem->bLoaded )
        {
            ...
            for ( UINT iPass = 0; iPass < cPasses; iPass++)
            {
                ...
                pd3dDevice->DrawIndexedPrimitive( D3DPT_TRIANGLESTRIP, 0, 0, g_Terrain.GetNumTileVertices(), 0, g_Terrain.GetNumIndices()-2 );
...
void	CALLBACK CreateVertexBuffer9_Serial( IDirect3DDevice9* pDev, IDirect3DVertexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, DWORD FVF, D3DPOOL Pool, void* pData, void* pContext )
{
    ...
    CVertexBufferProcessor *pProcessor = new CVertexBufferProcessor( pDev, ppBuffer, iSizeBytes, Usage, FVF, Pool, pData, g_pResourceReuseCache );
...
void	CALLBACK CreateIndexBuffer9_Serial( IDirect3DDevice9* pDev, IDirect3DIndexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, D3DFORMAT ibFormat, D3DPOOL Pool, void* pData, void* pContext )
{
    ...
    CIndexBufferProcessor *pProcessor = new CIndexBufferProcessor( pDev, ppBuffer, iSizeBytes, Usage, ibFormat, Pool, pData, g_pResourceReuseCache );
