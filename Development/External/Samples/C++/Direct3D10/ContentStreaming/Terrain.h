...
public:
    ...
    HRESULT LoadTerrain( WCHAR* strHeightMap, UINT SqrtNumTiles, UINT NumSidesPerTile, float fWorldScale, float fHeightScale, bool bCreateTiles );
    ...
    SHORT* GetIndices() { return m_pTerrainRawIndices; }
    UINT GetNumTileVertices() { return (m_NumSidesPerTile+1)*(m_NumSidesPerTile+1); }
