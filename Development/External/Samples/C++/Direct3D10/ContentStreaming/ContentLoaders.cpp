...
//--------------------------------------------------------------------------------------
CTextureLoader::CTextureLoader( WCHAR* szFileName, CPackedFile* pPackedFile ) :
m_pData(NULL),
m_cBytes(0),
...
HRESULT WINAPI CTextureProcessor::LockDeviceObject( )
{
    ...
    if( LDT_D3D10 == m_Device.Type )
    {
        m_pRealRV10 = m_pResourceReuseCache->GetFreeTexture10( Width, Height, MipLevels, (UINT)Format, &m_pStaging10 );
