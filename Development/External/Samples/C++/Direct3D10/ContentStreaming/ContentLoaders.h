...
public:
    CTextureProcessor( ID3D10Device* pDevice, ID3D10ShaderResourceView** ppRV10, CResourceReuseCache* pResourceReuseCache, UINT SkipMips );
    CTextureProcessor( IDirect3DDevice9* pDevice, IDirect3DTexture9** ppTexture9, CResourceReuseCache* pResourceReuseCache, UINT SkipMips );
    ~CTextureProcessor();
