...
public:
    ...
    bool CreatePackedFile( ID3D10Device* pDev10, IDirect3DDevice9* pDev9, WCHAR* szFileName, UINT SqrtNumTiles, UINT SidesPerTile, float fWorldScale, float fHeightScale );
