...
public:
    inline unsigned long GetNumSamples() { return m_ulNumSamples; }
    inline unsigned long GetNumChannels() { return m_ulNumChannels; }
...
public:
	...
	unsigned char* GetRawBits() { return m_pBits; }
	unsigned long GetBitsSize() { return m_ulBitsSize; }
	WAVEFORMATEX GetFormat() { return m_wfx; };
};