...
public:
	...
	HRESULT LoadTerrain( WCHAR* strHeightMap, UINT SqrtNumTiles, UINT NumSidesPerTile, float fWorldScale, float fHeightScale,
	...
	LPDIRECT3DINDEXBUFFER9 GetTerrainIB() { return m_pTerrainIB; }
	ID3D10Buffer* GetTerrainIB10() { return m_pTerrainIB10; }
...
//--------------------------------------------------------------------------------------
template <class T>
void QuickDepthSort(T* indices, float* depths, int lo, int hi)
{
