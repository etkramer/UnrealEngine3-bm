...
BOOL WINAPI PIXBeginExperiment( PIXCOUNTERID id, const WCHAR* pstrApplication )
{
    switch( id )
    {
    case CTR_TERRAINTILESDRAWN: return SharedMemoryInit( pstrApplication );
    case CTR_GRASSTILESDRAWN:   return SharedMemoryInit( pstrApplication );
    case CTR_BALLSDRAWN:        return SharedMemoryInit( pstrApplication );
    case CTR_MAXBALLSPERGRID:   return SharedMemoryInit( pstrApplication );
...
BOOL WINAPI PIXEndFrame( PIXCOUNTERID id, UINT iFrame, DWORD* pdwReturnBytes, BYTE** ppReturnData )
{
    switch( id )
    {
    case CTR_TERRAINTILESDRAWN: return GetTerrainTiles( pdwReturnBytes, ppReturnData );
    case CTR_GRASSTILESDRAWN:   return GetGrassTiles( pdwReturnBytes, ppReturnData );
    case CTR_BALLSDRAWN:        return GetNumBalls( pdwReturnBytes, ppReturnData );
    case CTR_MAXBALLSPERGRID:   return GetMaxBalls( pdwReturnBytes, ppReturnData );
    default: return FALSE;
    }
}
...
BOOL WINAPI PIXEndExperiment( PIXCOUNTERID id )
{
    switch( id )
    {
    case CTR_TERRAINTILESDRAWN: return SharedMemoryUninit();
    case CTR_GRASSTILESDRAWN:   return SharedMemoryUninit();
    case CTR_BALLSDRAWN:        return SharedMemoryUninit();
    case CTR_MAXBALLSPERGRID:   return SharedMemoryUninit();
    default: return FALSE;
    }
}
