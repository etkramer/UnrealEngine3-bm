...
//-----------------------------------------------------------------------------
HRESULT CSkybox::OnD3D9CreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, float fSize, WCHAR* strCubeMapFile, WCHAR* strEffectFileName )
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CSkybox::OnD3D9CreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, float fSize, IDirect3DCubeTexture9* pCubeTexture, WCHAR* strEffectFileName )
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CSkybox::OnD3D10CreateDevice( ID3D10Device* pd3dDevice, float fSize, WCHAR* strCubeMapFile, WCHAR* strEffectFileName )
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CSkybox::OnD3D10CreateDevice( ID3D10Device* pd3dDevice, float fSize, ID3D10Texture2D* pCubeTexture, ID3D10ShaderResourceView* pCubeRV, WCHAR* strEffectFileName )
{
    HRESULT hr;
    ...
    #endif
    V_RETURN( D3DX10CreateEffectFromFile( str, NULL, NULL, "fx_4_0", dwShaderFlags, 0, pd3dDevice, NULL, NULL, &m_pEffect10, NULL, NULL ) );
    ...
    V_RETURN( pd3dDevice->CreateInputLayout( g_aVertexLayout, 1, PassDesc.pIAInputSignature, PassDesc.IAInputSignatureSize, &m_pVertexLayout10 ) );
