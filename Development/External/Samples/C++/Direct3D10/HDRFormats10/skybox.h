...
public:
    ...
    // D3D9 methods
    HRESULT OnD3D9CreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, float fSize, WCHAR* strCubeMapFile, WCHAR* strEffectFileName );
    HRESULT OnD3D9CreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, float fSize, IDirect3DCubeTexture9* pCubeTexture, WCHAR* strEffectFileName );
    ...
    IDirect3DCubeTexture9* GetD3D9EnvironmentMap() { return m_pEnvironmentMap9; }
    void SetD3D9EnvironmentMap( IDirect3DCubeTexture9* pCubeTexture ) { m_pEnvironmentMap9 = pCubeTexture; }

    // D3D10 methods
    HRESULT OnD3D10CreateDevice( ID3D10Device* pd3dDevice, float fSize, WCHAR* strCubeMapFile, WCHAR* strEffectFileName );
    HRESULT OnD3D10CreateDevice( ID3D10Device* pd3dDevice, float fSize, ID3D10Texture2D* pCubeTexture, ID3D10ShaderResourceView* pCubeRV, WCHAR* strEffectFileName );
    ...
    ID3D10Texture2D* GetD3D10EnvironmentMap() { return m_pEnvironmentMap10; }
    ID3D10ShaderResourceView* GetD3D10EnvironmentMapRV() { return m_pEnvironmentRV10; }
    void SetD3D10EnvironmentMap( ID3D10Texture2D* pCubeTexture ) { m_pEnvironmentMap10 = pCubeTexture; }
