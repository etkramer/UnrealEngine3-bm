...
public:
    CMorphTarget();
    ~CMorphTarget();
    ID3D10ShaderResourceView* GetTexRV() { return m_pTexRV; }
    D3DXVECTOR4 GetMaxPositionDelta() { return D3DXVECTOR4(m_Header.vMaxPositionDelta,1); }
    D3DXVECTOR4 GetMaxNormalDelta() { return D3DXVECTOR4(m_Header.vMaxNormalDelta,1); }
    D3DXVECTOR4 GetMaxTangentDelta() { return D3DXVECTOR4(m_Header.vMaxTangentDelta,1); }
    ...
    void RenderToTexture( ID3D10Device* pd3dDevice, ID3D10RenderTargetView* pRTV, ID3D10DepthStencilView* pDSV, ID3D10EffectTechnique* pTechnique );
