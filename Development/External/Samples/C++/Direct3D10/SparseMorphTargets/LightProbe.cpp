...
//-----------------------------------------------------------------------------
HRESULT CLightProbe::OnCreateDevice( ID3D10Device* pd3dDevice, const WCHAR* strCubeMapFile, bool bCreateSHEnvironmentMapTexture )
{
    HRESULT hr;
    ...
    float RData[36] = { 3.787913f, -2.886524f, 0.391213f, 1.032084f, -0.616243f, -0.083525f, -0.933374f, 0.583966f, 0.210076f, -1.372014f, -0.563307f, -0.049150f, 0.114473f, 0.005523f, 0.781353f, 0.584010f, -1.036219f, -0.819325f, -0.157718f, -0.563764f, -0.215438f, -0.164376f, -0.225869f, 0.001518f, -0.345120f, -1.023554f, -0.417133f, 0.093116f, 0.046153f, -0.017157f, -0.347141f, -0.561792f, -0.237663f, 0.341074f, -0.073624f, -0.231714f };
    float GData[36] = { 4.270733f, -3.584769f, 0.308809f, 1.029689f, -0.548223f, 0.140985f, -1.254231f, 0.515082f, -0.036361f, -1.459587f, -0.539529f, 0.061784f, 0.308022f, 0.033875f, 0.952719f, 0.729536f, -1.145294f, -0.904861f, -0.195431f, -0.742667f, -0.185562f, -0.180466f, -0.365853f, -0.098596f, -0.411357f, -1.113933f, -0.324883f, 0.309895f, 0.073759f, -0.008792f, -0.452596f, -0.621296f, -0.248816f, 0.360404f, -0.139558f, -0.188815f };
    float BData[36] = { 4.517528f, -4.147918f, 0.112664f, 0.882139f, -0.390195f, 0.462362f, -1.528599f, 0.376815f, -0.443945f, -1.357518f, -0.462659f, 0.200063f, 0.593371f, 0.049003f, 1.095982f, 0.825668f, -1.158036f, -0.941781f, -0.198669f, -0.954177f, -0.144703f, -0.146712f, -0.499070f, -0.233005f, -0.459772f, -1.102844f, -0.133849f, 0.557828f, 0.070334f, 0.033467f, -0.555929f, -0.622049f, -0.259303f, 0.364954f, -0.250672f, -0.138154f };
    ...
    #endif
    V_RETURN( D3DX10CreateEffectFromFile( str, NULL, NULL, "fx_4_0", dwShaderFlags, 0, pd3dDevice, NULL, NULL, &m_pEffect, NULL, NULL ) );
    ...
    V_RETURN( pd3dDevice->CreateInputLayout( vertlayout, sizeof(vertlayout)/sizeof(vertlayout[0]), PassDesc.pIAInputSignature, PassDesc.IAInputSignatureSize, &m_pVertLayout ) );
