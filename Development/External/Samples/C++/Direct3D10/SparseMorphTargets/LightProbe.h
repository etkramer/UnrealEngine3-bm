...
public:
    ...
    HRESULT OnCreateDevice( ID3D10Device* pd3dDevice, const WCHAR* strCubeMapFile, bool bCreateSHEnvironmentMapTexture );
    ...
    ID3D10ShaderResourceView* GetEnvironmentMapRV()   { return m_pEnvironmentMapRV; }
