...
HRESULT CALLBACK OnD3D10CreateDevice( ID3D10Device* pd3dDevice, const DXGI_SURFACE_DESC *pBackBufferSurfaceDesc, void* pUserContext )
{
    ...
    V_RETURN( pd3dDevice->CreateInputLayout( vertlayout_multiindex, iNumElements, PassDesc.pIAInputSignature, PassDesc.IAInputSignatureSize, &g_pVertexLayout_MI ) );
...
void CALLBACK OnGUIEvent( UINT nEvent, int nControlID, CDXUTControl* pControl, void* pUserContext )
{
    switch( nControlID )
    {
        ...
        case IDC_FIXEDFUNC:        g_bRenderFF = !g_bRenderFF; break;
        case IDC_ALTERNATIVE_UV:   g_bUseAltUV = !g_bUseAltUV; break;
        case IDC_MULTI_INDEX:      g_bUseMultiIndex = !g_bUseMultiIndex; break;
    }
}
