...
VOID OnSliderChanged( HWND hDlg )
{
    ...
    StringCchPrintf( strBuffer, 10, TEXT("%.2f"), fDopplerFactor );
    SetWindowText( GetDlgItem( hDlg, IDC_DOPPLERFACTOR ), strBuffer );

    StringCchPrintf( strBuffer, 10, TEXT("%.2f"), fRolloffFactor );
    SetWindowText( GetDlgItem( hDlg, IDC_ROLLOFFFACTOR ), strBuffer );

    StringCchPrintf( strBuffer, 10, TEXT("%.2f"), fMinDistance );
    SetWindowText( GetDlgItem( hDlg, IDC_MINDISTANCE ), strBuffer );

    StringCchPrintf( strBuffer, 10, TEXT("%.2f"), fMaxDistance );
