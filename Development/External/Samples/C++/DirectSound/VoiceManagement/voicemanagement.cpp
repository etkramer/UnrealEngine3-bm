...
VOID UpdateBehaviorText( HWND hDlg )
{
    ...
    if( bAllocSW )
    {
        StringCchCopy( strExcepted, 1024, L"The new sound will be played in software" );
    }

    if( bAllocHW )
    {
        StringCchCopy( strExcepted, 1024, L"The new sound will be played in hardware" );
    }
    ...
    if( bByTime )
    {
        if( bByPriority )
        {
            ...
            {
                StringCchCat( strExcepted, 1024, L", and if the hardware has no available "
    ...
    else
    {
        ...
        {
            StringCchCat( strExcepted, 1024, L", and the buffer will not steal any "
