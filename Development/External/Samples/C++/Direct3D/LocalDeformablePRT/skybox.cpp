...
//-----------------------------------------------------------------------------
HRESULT CSkybox::OnCreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, float fSize, LPDIRECT3DCUBETEXTURE9 pEnvMap, WCHAR* strEffectFileName )
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CSkybox::OnCreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, float fSize, WCHAR* strCubeMapFile, WCHAR* strEffectFileName )
{
    HRESULT hr;
    ...
    V_RETURN( D3DXCreateCubeTextureFromFileEx( pd3dDevice, strPath, 512, 1, 0, D3DFMT_A16B16G16R16F, 
                                               D3DPOOL_MANAGED, D3DX_FILTER_LINEAR, D3DX_FILTER_LINEAR, 0, NULL, NULL, &pEnvironmentMap ) );
