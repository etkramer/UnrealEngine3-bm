...
enum ENCODING_MODE { FP16, FP32, RGB16, RGBE8, NUM_ENCODING_MODES };
...
void CALLBACK OnFrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    { 
        ...
        {
            case DECODED:       g_pEffect->SetTechnique( g_pCurTechnique->FinalPass ); break;
            case RGB_ENCODED:   g_pEffect->SetTechnique( "FinalPassEncoded_RGB" ); break;
            case ALPHA_ENCODED: g_pEffect->SetTechnique( "FinalPassEncoded_A" ); break;
        }
