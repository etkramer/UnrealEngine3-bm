...
class CIrradianceCacheGenerator
{
   public :
      ...
      //=========================================================//
      bool SetSamplingInfo ( DWORD dwMaxSubdivision, bool bAdaptiveSubdivision, DWORD dwMinSubdivision, float fHMDepthSubdivThreshold );
      ...
      //======================================================================================================//
      bool SetGPUResources ( IDirect3DDevice9* pD3DDevice, ID3DXRenderToEnvMap* pRenderToEnvMap, IDirect3DCubeTexture9* pCubeTexture );
   ...
   protected :
      ...
      // Disallow copying //
      //==================//
      CIrradianceCacheGenerator ( CIrradianceCacheGenerator& o ) { assert( false ); };
      CIrradianceCacheGenerator& operator = ( CIrradianceCacheGenerator& o ) { assert( false ); };
};
...
class CIrradianceCache
{
   ...
   public :
      ...
      //==========================================//
      bool SampleTrilinear ( D3DXVECTOR3* pPosition, CIrradianceCache::IrradianceSample* pSample, D3DXVECTOR3 pBox[8] );
   ...
   protected :
      ...
      //======================================//
      CIrradianceCache ( void ) { assert( false ); };
      CIrradianceCache ( CIrradianceCache& o ) { assert( false ); };
      CIrradianceCache& operator = ( CIrradianceCache& o ) { assert( false ); };
};
...
class CIrradianceCacheOctree
{
   ...
   public :
      ...
      //================================//
      CIrradianceCacheOctree::OctreeNode* GetRootNode ( void ) { return &m_root; };

      //======================================================================================================//
      // Return the smallest Octree node that encloses the specified point, tree traversal starts with pNode. //
      //======================================================================================================//
      CIrradianceCacheOctree::OctreeNode* FindEnclosingNode ( D3DXVECTOR3* pPosition, CIrradianceCacheOctree::OctreeNode* pNode );
   ...
   protected :
      ...
      //==================================================================================//
      CIrradianceCacheOctree::OctreeNode* FindUnsampledNode ( CIrradianceCacheOctree::OctreeNode* pNode,  DWORD* pDepth = NULL);
      ...
      //=============================================//
      bool SetNodeBounds ( CIrradianceCacheOctree::OctreeNode* pNode, D3DXVECTOR3* pBoundBoxMin, D3DXVECTOR3* pBoundBoxMax );
      ...
      //========================================================//
      CIrradianceCacheOctree ( void ) { assert( false ); };
      CIrradianceCacheOctree ( CIrradianceCacheOctree& o ) { assert( false ); };
      CIrradianceCacheOctree& operator = ( CIrradianceCacheOctree& o ) { assert( false ); };
};
