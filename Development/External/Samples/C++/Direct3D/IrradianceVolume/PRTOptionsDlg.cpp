...
COptionsFile::COptionsFile()
{
    ...
    StringCchCopy( m_strFile, MAX_PATH, strPath );
    StringCchCat( m_strFile, MAX_PATH, L"options.xml" );
        ...
        case WM_COMMAND:
            switch( LOWORD(wParam) )
            {
                ...
                case IDC_PREDEF_COMBO:
                    if( HIWORD(wParam) == CBN_SELCHANGE )
                    {
                        ...
                        if( lResult != CB_ERR )
                        {
                            ...
                            StringCchPrintf( sz, 256, TEXT("%0.4f"), pMat->Absorption.r ); SetDlgItemText( hDlg, IDC_ABSORPTION_R_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.4f"), pMat->Absorption.g ); SetDlgItemText( hDlg, IDC_ABSORPTION_G_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.4f"), pMat->Absorption.b ); SetDlgItemText( hDlg, IDC_ABSORPTION_B_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->Diffuse.r ); SetDlgItemText( hDlg, IDC_REFLECTANCE_R_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->Diffuse.g ); SetDlgItemText( hDlg, IDC_REFLECTANCE_G_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->Diffuse.b ); SetDlgItemText( hDlg, IDC_REFLECTANCE_B_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->ReducedScattering.r ); SetDlgItemText( hDlg, IDC_SCATTERING_R_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->ReducedScattering.g ); SetDlgItemText( hDlg, IDC_SCATTERING_G_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->ReducedScattering.b ); SetDlgItemText( hDlg, IDC_SCATTERING_B_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.2f"), pMat->fRelativeIndexOfRefraction ); SetDlgItemText( hDlg, IDC_REFRACTION_EDIT, sz ); 
                            m_bComboBoxSelChange = false;
                        }
                    }
                    break;
                ...
                case IDC_INPUT_BROWSE_BUTTON:
                {
                    ...
                    {
                        StringCchCopy( GetGlobalOptions().strInitialDir, MAX_PATH, GetGlobalOptions().strInputMesh );
                        ...
                        if( pLastSlash )
                        {
                            *pLastSlash = 0;
                            ...
                            StringCchCopy( strResults, MAX_PATH, pLastSlash );
                            ...
                            StringCchCat( strFolder, MAX_PATH, g_szAppFolder );

                            StringCchCopy( strPath, MAX_PATH, strFolder );
                            StringCchCat( strPath, MAX_PATH, strResults );
                            StringCchCat( strPath, MAX_PATH, L"_prtresults.prt" );
                            StringCchCopy( GetGlobalOptions().strResultsFile, MAX_PATH, strPath );
                            ...
                            if( pLastDot )
                                *pLastDot = 0;
                            StringCchCat( strResults, MAX_PATH, L"_adaptive.x" );
                            StringCchCopy( strPath, MAX_PATH, strFolder );
                            StringCchCat( strPath, MAX_PATH, strResults );

                            StringCchCopy( GetGlobalOptions().strOutputMesh, MAX_PATH, strPath );
                ...
                case IDC_OUTPUT_BROWSE_BUTTON:
                {
                    ...
                    if( bResult )
                    {
                        StringCchCopy( GetGlobalOptions().strInitialDir, MAX_PATH, strResults );
                        WCHAR* pLastSlash =  wcsrchr( GetGlobalOptions().strInitialDir, L'\\' );
                        if( pLastSlash )
                            *pLastSlash = 0;
                        SetCurrentDirectory( GetGlobalOptions().strInitialDir );
                ...
                case IDC_OUTPUT_MESH_BROWSE_BUTTON:
                {
                    ...
                    {
                        StringCchCopy( GetGlobalOptions().strInitialDir, MAX_PATH, GetGlobalOptions().strResultsFile );
                        WCHAR* pLastSlash =  wcsrchr( GetGlobalOptions().strInitialDir, L'\\' );
                        if( pLastSlash )
                            *pLastSlash = 0;
                        SetCurrentDirectory( GetGlobalOptions().strInitialDir );
...
void COptionsFile::ResetSettings()
{
    ...
    StringCchCopy( m_Options.strInputMesh, MAX_PATH, L"PRT Demo\\LandShark.x" );
    ...
    if( pLastSlash )
        *pLastSlash = 0;
    StringCchCopy( m_Options.strResultsFile, MAX_PATH, L"LandShark_prtresults.prt" );
    m_Options.dwOrder = 6;
    ...
    StringCchCopy( m_Options.strOutputMesh, MAX_PATH, L"LandShark_adaptive.x" );
...
void CPRTOptionsDlg::UpdateControlsWithSettings( HWND hDlg )
{
    ...
    TCHAR sz[256];
    m_bComboBoxSelChange = true;
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().fRelativeIndexOfRefraction ); sz[255] = 0; SetDlgItemText( hDlg, IDC_REFRACTION_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.4f"), GetGlobalOptions().Absorption.r ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_R_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.4f"), GetGlobalOptions().Absorption.g ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_G_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.4f"), GetGlobalOptions().Absorption.b ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_B_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().Diffuse.r ); sz[255] = 0; SetDlgItemText( hDlg, IDC_REFLECTANCE_R_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().Diffuse.g ); sz[255] = 0; SetDlgItemText( hDlg, IDC_REFLECTANCE_G_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().Diffuse.b ); sz[255] = 0; SetDlgItemText( hDlg, IDC_REFLECTANCE_B_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().ReducedScattering.r ); sz[255] = 0; SetDlgItemText( hDlg, IDC_SCATTERING_R_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().ReducedScattering.g ); sz[255] = 0; SetDlgItemText( hDlg, IDC_SCATTERING_G_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().ReducedScattering.b ); sz[255] = 0; SetDlgItemText( hDlg, IDC_SCATTERING_B_EDIT, sz ); 
    m_bComboBoxSelChange = false;

    StringCchPrintf( sz, 256, TEXT("%0.1f"), GetGlobalOptions().fLengthScale ); sz[255] = 0; SetDlgItemText( hDlg, IDC_LENGTH_SCALE_EDIT, sz );
        ...
        case WM_COMMAND:
            switch( LOWORD(wParam) )
            {
                case IDC_INPUT_MESH_BROWSE_BUTTON:
                {
                    ...
                    if( TRUE == GetOpenFileName( &ofn ) )
                    {
                        StringCchCopy( GetGlobalOptions().strInitialDir, MAX_PATH, strMesh );
                        WCHAR* pLastSlash =  wcsrchr( GetGlobalOptions().strInitialDir, L'\\' );
                        if( pLastSlash )
                        {
                            *pLastSlash = 0;
                            ...
                            if( pLastDot )
                                *pLastDot = 0;
                            StringCchCat( strResults, MAX_PATH, L"_prtresults.prt" );
                            StringCchCopy( GetGlobalOptions().strResultsFile, MAX_PATH, strResults );
                            SetDlgItemText( hDlg, IDC_SIM_RESULTS_EDIT, GetGlobalOptions().strResultsFile );
                        }
                        SetCurrentDirectory( GetGlobalOptions().strInitialDir );
                        SetDlgItemText( hDlg, IDC_INPUT_MESH_EDIT, strMesh );
...
INT_PTR CALLBACK CPRTAdaptiveOptionsDlg::DlgProc( HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam )
{
    switch( msg )
    {
        case WM_INITDIALOG:
        {
            ...
            WCHAR sz[256];
            StringCchPrintf( sz, 256, L"%0.6f", GetGlobalOptions().fRobustMeshRefineMinEdgeLength ); sz[255] = 0; SetDlgItemText( hDlg, IDC_RMR_MIN_EDGE_EDIT, sz ); 
            StringCchPrintf( sz, 256, L"%0.6f", GetGlobalOptions().fAdaptiveDLMinEdgeLength ); sz[255] = 0; SetDlgItemText( hDlg, IDC_DL_MIN_EDGE_EDIT, sz ); 
            StringCchPrintf( sz, 256, L"%0.6f", GetGlobalOptions().fAdaptiveBounceMinEdgeLength ); sz[255] = 0; SetDlgItemText( hDlg, IDC_AB_MIN_EDGE_EDIT, sz ); 
            StringCchPrintf( sz, 256, L"%0.6f", GetGlobalOptions().fAdaptiveDLThreshold ); sz[255] = 0; SetDlgItemText( hDlg, IDC_DL_SUBD_THRESHOLD_EDIT, sz ); 
            StringCchPrintf( sz, 256, L"%0.6f", GetGlobalOptions().fAdaptiveBounceThreshold ); sz[255] = 0; SetDlgItemText( hDlg, IDC_AB_SUBD_THRESHOLD_EDIT, sz ); 
...
void CXMLHelper::CreateNewValue( IXMLDOMDocument* pDoc, IXMLDOMNode* pNode, WCHAR* strName, DWORD nValue )
{
    ...
    StringCchPrintf( strValue, MAX_PATH, L"%d", nValue );
...
{
    WCHAR strValue[MAX_PATH];
    StringCchPrintf( strValue, MAX_PATH, L"%f", fValue );
    CreateNewValue( pDoc, pNode, strName, strValue );
}
