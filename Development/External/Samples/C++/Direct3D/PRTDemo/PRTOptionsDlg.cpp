...
void COptionsFile::ResetSettings()
{
    ...
    StringCchCopy( m_Options.strInputMesh, MAX_PATH, L"misc\\shapes1.x" );
    ...
    if( pLastSlash )
        *pLastSlash = 0;
    StringCchCopy( m_Options.strResultsFile, MAX_PATH, L"shapes1_prtresults.prt" );
    m_Options.dwOrder = 6;
    ...
    StringCchCopy( m_Options.strOutputMesh, MAX_PATH, L"shapes1_adaptive.x" );
