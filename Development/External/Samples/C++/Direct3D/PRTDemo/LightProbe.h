...
public:
    ...
    HRESULT OnCreateDevice( LPDIRECT3DDEVICE9 pd3dDevice, const WCHAR* strCubeMapFile, bool bCreateSHEnvironmentMapTexture );
    ...
    LPDIRECT3DCUBETEXTURE9 GetSHEnvironmentMap() { return m_pSHEnvironmentMap; }
    LPDIRECT3DCUBETEXTURE9 GetEnvironmentMap()   { return m_pEnvironmentMap; }
    float*  GetSHData( int nChannel ) { if( nChannel < 0 || nChannel > 3 ) return NULL; else return m_fSHData[nChannel]; };
