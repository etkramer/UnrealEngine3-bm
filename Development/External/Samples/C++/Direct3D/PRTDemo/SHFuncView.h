...
public:
    ...
    void    GetVertexUnderMouse( CPRTMesh* pPRTMesh, int nAppTechnique, const D3DXMATRIX* pmProj, const D3DXMATRIX* pmView, const D3DXMATRIX* pmWorld );
    ...
    void    Render( IDirect3DDevice9* pd3dDevice, float fObjectRadius, D3DXMATRIX& mWorld, D3DXMATRIX& mView, D3DXMATRIX& mProj ); 
