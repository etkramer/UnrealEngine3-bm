...
void InitApp()
{
    ...
    WCHAR sz[100];
    iY += 10;
    StringCchPrintf( sz, 100, L"Sleep: %dms/frame", g_nSleepTime ); sz[99] = 0;
    ...
    iY += 10;
    StringCchPrintf( sz, 100, L"Blur Factor: %0.2f", g_fPixelBlurConst ); sz[99] = 0;
    ...
    iY += 10;
    StringCchPrintf( sz, 100, L"Object Speed: %0.2f", g_fObjectSpeed ); sz[99] = 0;
    ...
    iY += 10;
    StringCchPrintf( sz, 100, L"Camera Speed: %0.2f", g_fCameraSpeed ); sz[99] = 0;
    ...
    if( g_nCurrentScene == 1 )
    {
        ...
        for( iObject=0; iObject < NUM_OBJECTS; iObject++ )
        {
            ...
            if( iObject >= 30 && iObject < 41 )
            {
                ...
                vPos.y = 10.0f;
                vPos.z = sinf(g_fObjectSpeed*0.125f*fTime + 2*D3DX_PI/10*(iObject-30)) * fRadius - 25.0f;
            }
            ...
            // Update the current world matrix for this object
            D3DXMatrixTranslation( &g_pScene1Object[iObject]->g_mWorld, g_pScene1Object[iObject]->g_vWorldPos.x, g_pScene1Object[iObject]->g_vWorldPos.y, g_pScene1Object[iObject]->g_vWorldPos.z );
        }
    }
...
void RenderText()
{
    ...
    txtHelper.DrawFormattedTextLine( L"Blur=%0.2f Object Speed=%0.1f Camera Speed=%0.1f", g_fPixelBlurConst, g_fObjectSpeed, g_fCameraSpeed );
