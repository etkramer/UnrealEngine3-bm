...
//--------------------------------------------------------------------------------------
CEffect::CEffect( const wstring tsName, const LPD3DXEFFECT pEffect )
    : CResource<LPD3DXEFFECT>( tsName, pEffect )
{
...
HRESULT CMeshObject::Create( LPDIRECT3DDEVICE9 pDevice, LPCWSTR wszFilename, CMeshObject** ppMeshObject )
{
    ...
    *ppMeshObject = NULL;
    ...
    D3DVERTEXELEMENT9 DeclTangent = { 0, 32, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TANGENT, 0 };
...
CMeshObject::CMeshObject( LPDIRECT3DDEVICE9 pDevice,
                          ...
                          DWORD dwMaterials )
                          : CResource< LPD3DXMESH>( tsName, pMesh )
{
    while( dwMaterials-- )
    {
        CMaterial* pMaterial;
...
//--------------------------------------------------------------------------------------
CMaterial::CMaterial( LPDIRECT3DDEVICE9 pDevice, D3DXEFFECTINSTANCE* pEffectInstance )
    : m_pEffect( NULL ), m_pEffectInstance( NULL )
{
...
//--------------------------------------------------------------------------------------
CEffectInstance::CEffectInstance( const D3DXEFFECTINSTANCE* pEffectInstance, LPD3DXEFFECT pEffect )
    : m_pEffect( pEffect )
{
