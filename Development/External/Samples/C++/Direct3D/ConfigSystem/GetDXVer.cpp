...
HRESULT GetDirectXVersionViaFileVersions( DWORD* pdwDirectXVersionMajor, DWORD* pdwDirectXVersionMinor, WCHAR* pcDirectXVersionLetter );
...
HRESULT GetDXVersion( DWORD* pdwDirectXVersionMajor, DWORD* pdwDirectXVersionMinor, WCHAR* pcDirectXVersionLetter )
{
    ...
    *pcDirectXVersionLetter = ' ';
    ...
    if( !bGotDirectXVersion )
    {
        ...
        if( SUCCEEDED( GetDirectXVersionViaFileVersions( pdwDirectXVersionMajor, pdwDirectXVersionMinor, pcDirectXVersionLetter ) ) )
            bGotDirectXVersion = true;
    }
