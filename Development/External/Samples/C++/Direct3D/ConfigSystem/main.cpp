...
void CheckForSafeMode( WCHAR *wszLaunchFile, bool &bSafeMode, bool bInitialize )
{
    ...
    if( SUCCEEDED( hr ) )
    {
        ...
        // this point.
        StringCchCat( wszPath, MAX_PATH, L"\\ConfigSystem" );
        ...
        StringCchCopy( wszSearch, MAX_PATH, wszPath );
        StringCchCat( wszSearch, MAX_PATH, L"\\launch*.sta" );
        WIN32_FIND_DATAW fd;
        ...
        while( INVALID_HANDLE_VALUE != hFind )
        {
            ...
            StringCchCopy( wszPid, MAX_PATH, fd.cFileName + 6 );
            ...
            if( pDot )
            {
                *pDot = L'\0';
                ...
                if( !hProcess || STILL_ACTIVE != dwExitCode )
                {
                    ...
                    StringCchCopy( wszSearch, MAX_PATH, wszPath );
                    StringCchCat( wszSearch, MAX_PATH, L"\\" );
                    StringCchCat( wszSearch, MAX_PATH, fd.cFileName );
        ...
        if( bInitialize )
        {
            ...
            StringCchPrintf( wszLaunchFile, MAX_PATH, L"%s\\launch%u.sta", wszPath, GetCurrentProcessId() );
            HANDLE hFile = ::CreateFile( wszLaunchFile, GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL );
    ...
    else
    {
        ...
        switch( g_pCM->cf_ForceShader )
        {
            ...
            default:
            {
                ...
                StringCchPrintfA( szTechName, 50, "RenderScenePS%d", g_pCM->cf_ForceShader );
