...
{
    StringCchPrintfW( g_szStaticOutput, MAX_PATH, szFormat, cSizeBytes );
                                ...
                                const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
    ...
    V_RETURN( pd3dDevice->CreatePixelShader( reinterpret_cast< DWORD* >( pCode->GetBufferPointer() ), &g_pFinalPassPS ) );
...
void CALLBACK OnFrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    V( pd3dDevice->Clear(0, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_ARGB(0xFF, 0xFF, 0xFF, 0xFF), 1.0f, 0) );
...
void CALLBACK OnGUIEvent( UINT nEvent, int nControlID, CDXUTControl* pControl, void* pUserContext )
{
    ...
    switch( nControlID )
    {
        ...
        case IDC_THRESHOLDSLIDER: 
            {
                float fNewThreshold = static_cast< float >( g_Config.GetSlider( IDC_THRESHOLDSLIDER )->GetValue( ) ) / 10.0f;
                PostProcess::SetBrightPassThreshold( fNewThreshold );
                StringCchPrintf( str, 100, L"Bright-Pass Threshold: (%.2f)", fNewThreshold );
        ...
        case IDC_EXPOSURESLIDER:
            {
                ...
                StringCchPrintf( str, 100, L"Exposure: (%.2f)", g_fExposure );
        ...
        case IDC_MULTIPLIERSLIDER:
            {
                ...
                StringCchPrintf( str, 100, L"Gaussian Multiplier: (%.2f)", mul );
        ...
        case IDC_MEANSLIDER:
            {
                ...
                StringCchPrintf( str, 100, L"Gaussian Mean: (%.2f)", mean );
        ...
        case IDC_STDDEVSLIDER:
            {
                ...
                StringCchPrintf( str, 100, L"Gaussian Std. Dev: (%.2f)", sd );
