...
extern bool WriteFileW(const wstring& FilePath, const void* Contents, size_t Size);

extern bool WriteFileA(const string& FilePath, const string& Contents);
...
extern void ParseAnsiString(FILE* File, string& String);
/** Note: Caller is responsible for freeing String */
extern void ParseAnsiString(FILE* File, LPCSTR& String, UINT& StringLength);
extern void ParseUnicodeString(FILE* File, wstring& String);
