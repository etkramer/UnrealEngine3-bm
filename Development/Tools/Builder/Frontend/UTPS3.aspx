<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UTPS3.aspx.cs" Inherits="UTPS3" Debug="true" %>
...
<center>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large"
            Height="56px" Text="Epic Build System - Trigger Build from UT3 PS3 Branch" Width="640px" ForeColor="Blue"></asp:Label><br /><br />
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="11000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="11600" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="700" />
</SelectParameters>
 </asp:SqlDataSource>
