<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UTX360.aspx.cs" Inherits="UTX360" Debug="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Trigger a UT Build from the PS3 branch</title>
</head>
<body>
...
<center>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large"
            Height="56px" Text="Epic Build System - Trigger Build from UT3 X360 Branch" Width="640px" ForeColor="Blue"></asp:Label><br /><br />
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="12000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="12600" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="800" />
</SelectParameters>
 </asp:SqlDataSource>
