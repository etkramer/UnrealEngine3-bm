...
namespace RemotableType
{
    ...
    public interface IUPMS_Interface
    {
        ...
        int PlatformBuild_GetCount();

        // Get the total number of bytes stored on the master server
        long PlatformBuildFiles_GetTotalSize();
        ...
        ClientMachines ClientMachine_GetListForPlatformGroupUser( string Platform, string Group, string UserName );

        // Creates or updates a target machine to the current parameters
        long ClientMachine_Update( int ClientMachineID, string Platform, string Name, string Path, string ClientGroup, string User, string Email, bool Reboot );
        ...
        long Task_AddNew( long PlatformBuildID, DateTime ScheduleTime, int ClientMachineID, string UserName, bool RunAfterProp, string BuildConfig, string CommandLine, bool Recurring );
        ...
        int User_GetID( string UserName, string Email );
