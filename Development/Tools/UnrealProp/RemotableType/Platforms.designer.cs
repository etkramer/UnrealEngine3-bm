...
namespace RemotableType {
    ...
    public partial class Platforms : global::System.Data.DataSet {
        ...
        public partial class PlatformsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
...
namespace RemotableType.PlatformsTableAdapters {
    ...
    public partial class PlatformsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Platforms] ( [Name] ) VALUES ( @Name ); SELECT ID, Name FROM Platfor" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Platforms] SET [Name] = @Name WHERE ( ( [ID] = @Original_ID ) AND ( [Name" +
                "] = @Original_Name ) ); SELECT ID, Name FROM Platforms WHERE ( ID = @ID )";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT DISTINCT Platforms.ID, Platforms.Name
                         ...
                         WHERE ( Projects.ID = @ProjectID ) ORDER BY Platforms.ID";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProjectID", global::System.Data.SqlDbType.BigInt, 8, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByProject(Platforms.PlatformsDataTable dataTable, long ProjectID) {
        ...
        public virtual Platforms.PlatformsDataTable GetDataByProject(long ProjectID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((long)(ProjectID));
            Platforms.PlatformsDataTable dataTable = new Platforms.PlatformsDataTable();
            this.Adapter.Fill(dataTable);
