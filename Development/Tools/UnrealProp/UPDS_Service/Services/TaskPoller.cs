            ...
            while( true )
            {
                ...
                try
                {
                    ...
                    if( TaskID != 0 )
                    {
                        ...
                        {
                            Log.WriteLine( "UPDS TASK POLLER", Log.LogType.Important, "Latest full build does not exist!" );
                ...
                catch( Exception Ex )
                {
                    ...
                    {
                        Log.WriteLine( "UPDS TASK POLLER", Log.LogType.Error, "Unhandled exception: " + Ex.ToString() );
                    }
                }
#endif
            }
