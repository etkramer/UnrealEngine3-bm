...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span style="font-size: 8pt;">
        <asp:ScriptManager ID="TaskSchedulerScriptManager" runat="server">
        </asp:ScriptManager>
        <br />
        ...
        <asp:Panel ID="Panel_Builds" runat="server" Height="260px" Width="100%" BackColor="FloralWhite">
            <table width="100%" cellspacing="10">
                <tr>
                    <td style="background-color: inherit; width: 35%;" valign="top" align="left">
                        Projects:
                        <br />
                        <asp:DropDownList ID="TaskSchedulerProjectDropDown" runat="server" Width="75%" AutoPostBack="True" Font-Size="Small" >
                        </asp:DropDownList>
                        <br />
                        ...
                        Available platforms:
                        <br />
                        <asp:DropDownList ID="TaskSchedulerPlatformDropDown" runat="server" Width="75%" AutoPostBack="True" Font-Size="Small" >
                        </asp:DropDownList>
                        <br />
                    ...
                    <td style="background-color: inherit;" valign="top" align="left">
                        ...
                        <asp:UpdatePanel ID="BuildListUpdatePanel" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:ListBox ID="BuildsListBox" runat="server" Font-Size="Small" Height="200px" Width="90%" OnPreRender="BuildsListBox_PreRender" AutoPostBack="True" DataSourceID="BuildDataSource" DataTextField="Description" DataValueField="ID" >
                                </asp:ListBox>
                            </ContentTemplate>
                            <Triggers>
        ...
        <asp:Panel ID="Panel_Targets" runat="server" Height="200px" Width="100%" BackColor="FloralWhite" HorizontalAlign="Left" ScrollBars="Vertical">
                    ...
                    <table width="100%" cellspacing="10">
                        <tr>
                            <td style="background-color: inherit; width: 35%;" valign="top" align="left">
                                ...
                                <br />
                                <br />
                                <asp:CheckBoxList ID="GroupCheckBoxes" runat="server" AutoPostBack="True" Font-Size="Small" BackColor="FloralWhite"
                            ...
                            <td style="background-color: inherit; width: 65%;" valign="top" align="left">
                                ...
                                <asp:DataList ID="ClientMachineList" runat="server" DataKeyField="ID" DataSourceID="TargetMachineDataSource" RepeatColumns="3" >
                                    <ItemTemplate>
                                        <asp:CheckBox ID="TargetCheckBox" runat="server" Font-Size="Small" BackColor="FloralWhite"
                        ...
                        <tr>
                            ...
                            <td style="background-color: inherit; width: 65%;" valign="top" align="left">
                                ...
                                <asp:DataList ID="PCMachineList" runat="server" DataKeyField="ID" DataSourceID="PCMachineDataSource" RepeatColumns="3" >
                                    <ItemTemplate>
                                        <asp:CheckBox ID="PCCheckBox" runat="server" Font-Size="Small" BackColor="FloralWhite"
                                            Text='<%# Eval("Name") %>' ToolTip='<%# Eval("Path") %>' />
                                        <asp:HiddenField ID="HiddenID" runat="server" Value='<%# Eval("ID") %>' />
                                    </ItemTemplate>
                                </asp:DataList>
        ...
        <asp:Panel ID="Panel_Time" runat="server" Height="120px" Width="100%" BackColor="FloralWhite">
                ...
                <table width="35%" cellpadding="0" cellspacing="10">
                    ...
                    <tr>
                        <td style="background-color: inherit; width: 100%;" valign="top">
                            ...
                            <br />
                            <asp:TextBox ID="ScheduleTime" runat="server" Height="16px" ValidationGroup="MKE" Width="75%">
                            </asp:TextBox>
        ...
        <asp:Panel ID="Panel_RunOptions" runat="server" Height="110px" Width="100%" BackColor="FloralWhite">
            <table width="100%" cellspacing="10">
                <tr>
                        ...
                        <asp:UpdatePanel ID="RunOptionsUpdatePanel" runat="server">
                            <ContentTemplate>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="width: 35%;" >
                                            <asp:DropDownList ID="DropDownList_AvailableConfigs" runat="server" Width="75%" AutoPostBack="True" OnDataBinding="AvailableConfigs_DataBind"
                                                 Font-Size="Small" >
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 65%;" >
                                            <asp:TextBox ID="TextBox_RunCommandLine" runat="server" AutoPostBack="True" Width="75%" />
                                        </td>
                                    </tr>
                                </table>
                                <br />
