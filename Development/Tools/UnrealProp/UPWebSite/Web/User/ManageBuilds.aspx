...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <center>
        <table style="width: 60%; font-size: small;" >
            <tr>
            ...
            <tr>
                ...
                <td valign="top" align="center" style="width: 20%; height: 21px;" >
                    <asp:DropDownList ID="ManageBuildsUserDropDown" runat="server" AutoPostBack="True" Width="75%" Font-Size="Small" OnPreRender="ManageBuildsUserDropDown_PreRender" >
                    </asp:DropDownList>
                </td>                   
                <td valign="top" align="center" style="width: 20%; height: 21px;" >
    ...
    <asp:UpdatePanel ID="UserManageBuildsUpdatePanel" runat="server" UpdateMode="Conditional">
        ...
        <center>
            <asp:GridView ID="UserBuildsGridView" runat="server" DataSourceID="BuildDataSource" AutoGenerateColumns="false" CellPadding="4" DataKeyNames="ID" ForeColor="#333333" Width="95%" PageSize="20"
                GridLines="None" AllowPaging="True" AllowSorting="True" Font-Size="Small" OnRowUpdating="UserBuildsGridView_RowUpdating" OnRowDataBound="UserBuildsGridView_RowDataBound">
