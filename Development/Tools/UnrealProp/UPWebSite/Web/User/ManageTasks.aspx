...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="TasksUserScriptManager" runat="server">
    </asp:ScriptManager>
    <br />
    <center>
        <table style="width: 80%; font-size: small;" >
            ...
            <tr>
                <td valign="top" align="center" style="width: 20%; height: 21px;">
                    <asp:DropDownList ID="UserTaskStatusDropDown" runat="server" Font-Size="Small" Width="75%" AutoPostBack="True">
                    </asp:DropDownList>
                </td>
                <td valign="top" align="center" style="width: 20%; height: 21px;" >
                    <asp:DropDownList ID="UserTaskProjectDropDown" runat="server" Font-Size="Small" Width="75%" AutoPostBack="True" >
                    </asp:DropDownList>
                </td>
                <td valign="top" align="center" style="width: 20%; height: 21px;" >
                    <asp:DropDownList ID="UserTaskPlatformDropDown" runat="server" Font-Size="Small" Width="75%" AutoPostBack="True" >
                    </asp:DropDownList>
                </td>
                <td valign="top" align="center" style="width: 20%; height: 21px;">
                    <asp:UpdatePanel ID="UserTaskUPDSUpdatePanel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="UserTaskUPDSDropDown" runat="server" Width="75%" Font-Size="Small" OnDataBinding="UserTaskUPDSDropDown_DataBinding" AutoPostBack="True" >
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="UserTaskConnectedOnlyCheckBox" EventName="CheckedChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 20%;" align="center" valign="top" >
                    <asp:CheckBox ID="UserTaskConnectedOnlyCheckBox" runat="server" Text="Connected Only" Width="120px" AutoPostBack="True" OnCheckedChanged="UserTaskConnectedOnlyCheckBox_CheckedChanged" />
                </td>
            </tr>
        </table>
    </center>            
