...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="TasksAdminScriptManager" runat="server">
    </asp:ScriptManager>
    <br />
    <table style="width: 100%; text-align:center; font-size: small;" >
        ...
        <tr>
            <td valign="top" align="center">
                <asp:DropDownList ID="AdminTaskStatusDropDown" runat="server" Font-Size="Small" Width="75%"  AutoPostBack="True">
                </asp:DropDownList>
            </td>
            <td  valign="top" align="center">
                <asp:DropDownList ID="AdminTaskProjectDropDown" runat="server" Font-Size="Small" Width="75%" AutoPostBack="True" >
                </asp:DropDownList>
            </td>
            <td  valign="top" align="center">
                <asp:DropDownList ID="AdminTaskPlatformDropDown" runat="server" Font-Size="Small" Width="75%" AutoPostBack="True" >
                </asp:DropDownList>
            </td>
            <td valign="top" align="center" style="height: 21px;">
                <asp:DropDownList ID="AdminTaskUserDropDown" runat="server" Font-Size="Small" Width="75%" AutoPostBack="True" DataSourceID="UserDataSource" OnDataBound="AdminTaskUserDropDown_DataBound" >
                </asp:DropDownList>
            ...
            <td valign="top" align="center">
                <asp:UpdatePanel ID="AdminTaskUPDSUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="AdminTaskUPDSDropDown" runat="server" Width="75%" Font-Size="Small" OnDataBinding="AdminTaskUPDSDropDown_DataBinding" AutoPostBack="True" >
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="AdminTaskConnectedOnlyCheckBox" EventName="CheckedChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
        <tr>
            ...
            <td align="center" valign="top">
                <asp:CheckBox ID="AdminTaskConnectedOnlyCheckBox" runat="server" Text="Connected Only" Width="120px" AutoPostBack="True" OnCheckedChanged="AdminTaskConnectedOnlyCheckBox_CheckedChanged" />
            </td>
        </tr>
    </table>
