...
namespace UnrealControls
{
    ...
    public partial class MenuArrow : UserControl
    {
        ...
        //MenuArrowClickedDelegate m_mnuClickedHandlers;

        //public event MenuArrowClickedDelegate Click
        //{
        //    add { m_mnuClickedHandlers += value; }
        //    remove { m_mnuClickedHandlers -= value; }
        //}
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.FillPolygon(SystemBrushes.MenuText, arrowPts);

            if(mDrawLine)
            {
                e.Graphics.FillRectangle(SystemBrushes.MenuText, 3, 3, this.Width - 6, 2);
            }
