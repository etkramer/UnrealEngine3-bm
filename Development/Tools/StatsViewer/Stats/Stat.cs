...
namespace Stats
{
	...
	public class Stat : UIBaseElement
	{
		...
		/// <summary>
		/// True if this stat represents time spent in a script function
		/// </summary>
		public bool bIsScriptFunctionStat;
		...
		public void FixupData(double SecondsPerCycle,SortedList StatIdToStat)
		{
			...
			bIsScriptFunctionStat = CannonicalStat.bIsScriptFunctionStat;
