...
namespace StatsViewer
{
	...
	public class FTreeListView : Control
	{
		...
		private void DrawRow(Graphics Gfx, FTreeListViewItem Item, float XOff, float ChildXOff, float YOff, bool bSelected )
		{
			...
			{
				DrawRowEntry( Gfx, Item.Text, ColumnCollection[ 0 ], ref IndentedGlyphOffsetRect, Item.BackColor, Item.ForeColor, bSelected );
			}
			...
			for(int i = 0; i < NumIterations; ++i)
			{
				...
				{
					DrawRowEntry(Gfx, Item.SubItems[i].Text, Column, ref Rect, Item.BackColor, Item.ForeColor, bSelected);
				}
				else
				{
					DrawRowEntry(Gfx, Item.SubItems[i].Text, Column, ref Rect, Item.SubItems[i].BackColor, Item.SubItems[i].ForeColor, bSelected);
				}
		 ...
		 */
		private void DrawRowEntry(Graphics Gfx, string Text, FTreeListViewColumnHeader Column, ref RectangleF Rect, Color BackgroundColor, Color ForeGroundColor, bool bSelected)
		{
