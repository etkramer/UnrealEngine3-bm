...
namespace StatsViewer
{
	...
	public class StatsViewerFrame : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.StatGroupsTree.Size = new System.Drawing.Size( 200, 508 );
			...
			this.StatsArea.Size = new System.Drawing.Size( 597, 508 );
			...
			this.StatsGraphPanel.Size = new System.Drawing.Size( 597, 361 );
			...
			this.StatsGraphScrollbar.Location = new System.Drawing.Point( 0, 344 );
			this.StatsGraphScrollbar.Name = "StatsGraphScrollbar";
			this.StatsGraphScrollbar.Size = new System.Drawing.Size( 597, 17 );
			...
			this.StatDataList.Location = new System.Drawing.Point( 0, 364 );
		...
		private void AddStatToList( Stat StatToAdd )
		{
			...
			if( AggData != null )
			{
				...
				lvi.SubItems.Add( CurFrameTotal.ToString( "F2" ) );
		...
		void DrawLeftMarkers( Graphics Gfx, int ViewportHeight )
		{
            ...
            Gfx.DrawLine( Pens.Black, 0, ViewportHeight / 4, 6, ViewportHeight / 4 );
            Gfx.DrawLine( Pens.Black, 0, ViewportHeight / 2, 6, ViewportHeight / 2 );
            Gfx.DrawLine( Pens.Black, 0, ViewportHeight * 3 / 4, 6, ViewportHeight * 3 / 4 );
            ...
            Gfx.DrawString( QuarterScaledValue.ToString(), GraphFont, Brushes.Black, 2, ViewportHeight * 3 / 4 + 2 );
			Gfx.DrawString( HalfMaxScaledValue.ToString(), GraphFont, Brushes.Black, 2, ViewportHeight / 2 + 2 );
            Gfx.DrawString( ThreeQuarterScaledValue.ToString(), GraphFont, Brushes.Black, 2, ViewportHeight / 4 + 2 );
            ...
            if( MaxScaledValue > 33.3 && MaxScaledValue <= 1000 )
            {
                ...
                Gfx.DrawLine( Pens.Black, 0, VSyncY, 6, VSyncY );
            }
		}
							...
							for( int FrameNo = DrawRangeStart; FrameNo < DrawRangeEnd; FrameNo++ )
							{
								...
								if( CurrentFrame != null && NextFrame != null )
								{
									...
									if( FirstStat != null && NextStat != null )
									{
										...
										{
											StartY = ViewportHeight - (int)( YScale * FirstStat.TotalTime );
											EndY = ViewportHeight - (int)( YScale * NextStat.TotalTime );
										}
										else
										{
											StartY = ViewportHeight - (int)( YScale * FirstStat.Total );
											EndY = ViewportHeight - (int)( YScale * NextStat.Total );
										}
		...
		private void ConnectToIP_Click( object sender, System.EventArgs e )
		{
			...
			if( IsConnected() )
			{
				if( PerformDisconnect( true ) == false )
				{
					// Now prompt to save the data
					PerformSave( true );
				}
