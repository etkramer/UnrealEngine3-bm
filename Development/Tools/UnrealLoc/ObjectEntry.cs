...
namespace UnrealLoc
{
    public class ObjectEntry
    {
        ...
        {
            get { return ( LocalObjectName ); }
            set { LocalObjectName = value; }
        }
    ...
    public class ObjectEntryHandler
    {
        ...
        private StreamReader OpenLocFile( string FileName )
        {
            StreamReader Reader = null;
            Main.Log( UnrealLoc.VerbosityLevel.Informative, " ... loading '" + FileName + "'", Color.Black );
        ...
        {
            StreamReader Reader = OpenLocFile( Owner.RelativeName );
            if( Reader == null )
            {
                return ( false );
            }
        ...
        {
            StreamReader Reader = OpenLocFile( FileName );
            if( Reader == null )
            {
                return ( false );
            }
