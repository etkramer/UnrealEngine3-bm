...
namespace Epic.UnrealDebugger2005
{
    ...
    /// </summary>
    [Guid("58f08ec2-9154-47be-9be7-2932ce386f21")]
    public class UnrealWatchPane : ToolWindowPane
    {
        ...
        private UnrealWatch control;

        /// <summary>
        /// Standard constructor for the tool window.
        /// </summary>
        public UnrealWatchPane() :
            base(null)
        {
